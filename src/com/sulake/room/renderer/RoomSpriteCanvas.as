package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1029:Number = 60;
      
      private static const const_1463:Number = 50;
      ...
      private var var_2436:Number = -1.0E7;
      
      private var var_2431:Number = -1.0E7;
      ...
      private var var_1771:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_255.addChild(this.var_104);
         ...
         this.var_254 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_832 = new ColorTransform();
         this.var_614 = new Matrix();
      ...
      {
         this.var_514.x -= param1 - this.var_617;
         this.var_617 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_514.y -= param1 - this.var_618;
         this.var_618 = param1;
      }
      ...
      {
         if(param1 && !this.var_1091)
         {
            this.var_1091 = true;
            if(this.var_135 != null && !this.var_255.contains(this.var_135))
            {
               this.var_255.addChild(this.var_135);
               this.var_104.mask = this.var_135;
            }
         }
         else if(!param1 && this.var_1091)
         {
            this.var_1091 = false;
            if(this.var_135 != null && this.var_255.contains(this.var_135))
            {
               this.var_255.removeChild(this.var_135);
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_516 != this.var_2435 || this.var_517 != this.var_2434)
         {
            _loc8_ = true;
         }
         if(this.var_104.x != this.var_617 || this.var_104.y != this.var_618)
         {
            this.var_104.x = this.var_617;
            this.var_104.y = this.var_618;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2435 = this.var_516;
         this.var_2434 = this.var_517;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1456 > 0)
         {
            _loc2_ = param1 - this.var_1456;
            if(_loc2_ > const_1029 * 3)
            {
            ...
            {
               ++this.var_760;
               if(this.var_760 == const_366 + 1)
               {
                  this.var_502 = _loc2_;
                  this.var_1771 = this.var_2433;
               }
               else if(this.var_760 > const_366 + 1)
               {
                  _loc3_ = Number(this.var_760 - const_366);
                  this.var_502 = this.var_502 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1771 = this.var_1771 * (_loc3_ - 1) / _loc3_ + Number(this.var_2433) / _loc3_;
                  if(this.var_760 > const_366 + const_1462)
                  {
                     this.var_760 = const_366;
                     if(!this.var_1170 && this.var_502 > const_1029)
                     {
                        this.var_1170 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1170 && this.var_502 < const_1463)
                     {
                        this.var_1170 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1770 && this.var_1170);
         ...
         _loc13_ += int(this.var_516 / 2);
         _loc14_ += int(this.var_517 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_617;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_618;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_617;
                     _loc17_.y = _loc20_ - this.var_618;
      ...
      {
         if(param1 < this.var_516 && param1 + param3 >= 0 && (param2 < this.var_517 && param2 + param4 >= 0))
         {
            if(!this.var_2975)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_516)
         {
            param3 -= this.var_516 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_517)
         {
            param4 -= this.var_517 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2432)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_954)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_954)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_761 || this.var_761 == 0)
         {
            _loc4_ = this.var_954 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_254.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_254.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_614.identity();
            if(flipH)
            {
               this.var_614.scale(-1,1);
               this.var_614.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_614.scale(1,-1);
               this.var_614.translate(0,data.height);
            }
            finalData.draw(data,this.var_614);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_832.redMultiplier = tR;
            this.var_832.greenMultiplier = tG;
            this.var_832.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_832);
            if(name.length > 0)
            {
               this.var_254.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1169 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1772;
         }
         this.var_1772 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1169;
         return this.var_1772;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_516 / 2;
         var _loc12_:Number = param2 - this.var_517 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1769,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2436 || param2 != this.var_2431)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
