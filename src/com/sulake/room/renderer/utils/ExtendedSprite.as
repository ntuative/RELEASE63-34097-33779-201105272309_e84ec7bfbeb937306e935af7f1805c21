package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1624:int = 128;
      
      private var var_1623:Boolean = false;
      
      private var var_3002:Point;
      ...
      {
         if(param1 != this.var_2108 || param2 != this.var_2109)
         {
      ...
      {
         if(this.var_1624 > 255 || bitmapData == null)
         {
            return false;
         }
