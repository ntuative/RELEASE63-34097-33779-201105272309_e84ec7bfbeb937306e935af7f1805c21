package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1351:Number = 32;
      ...
      private var var_2073:Number = 1.0;
      
      private var var_2074:Number = 1.0;
      
      private var var_2072:Number = 1.0;
      
      private var var_100:Vector3d;
      
      private var var_473:Vector3d;
      
      private var var_3000:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2072 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_474.assign(this.var_100);
         this.var_474.x *= this.var_475;
         this.var_474.y *= this.var_471;
         this.var_474.z *= this.var_472;
         return this.var_474;
      }
      ...
      {
         if(this.var_475 != param1 * this.var_2073)
         {
            this.var_475 = param1 * this.var_2073;
            ++this.var_174;
         }
      }
      ...
      {
         if(this.var_471 != param1 * this.var_2074)
         {
            this.var_471 = param1 * this.var_2074;
            ++this.var_174;
         }
      }
      ...
      {
         if(this.var_472 != param1 * this.var_2072)
         {
            this.var_472 = param1 * this.var_2072;
            ++this.var_174;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_100.x /= this.var_475;
         this.var_100.y /= this.var_471;
         this.var_100.z /= this.var_472;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1330.assign(this.var_171);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_562 != null)
         {
            ...
            this.var_562.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_562.add(_loc3_,_loc4_);
            ++this.var_174;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_562 != null)
         {
            ...
            return this.var_562.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1329.assign(_loc22_);
         }
         else
         {
            this.var_1329.assign(_loc17_);
         }
         ++this.var_174;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_471;
         _loc2_.z *= this.var_472;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1329);
         if(_loc3_ < this.var_3000 || _loc3_ > this.var_2999)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_471;
            _loc2_.z *= this.var_472;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1329);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_100.x * this.var_475,this.var_100.y * this.var_471,this.var_100.z * this.var_472);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_171;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_475,param2.y * this.var_471,param2.z * this.var_472);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_475,param3.y * this.var_471,param3.z * this.var_472);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_475,param4.y * this.var_471,param4.z * this.var_472);
