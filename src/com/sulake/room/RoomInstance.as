   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_258 != null)
         {
            ...
            {
               _loc3_ = this.var_258.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1482.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1481.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1481.push(param1);
         }
         if(this.var_628[param1] != param2)
         {
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_629.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_629[_loc2_]);
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(this.var_258.getValue(_loc2_) != null)
         {
            return this.var_258.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_258.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_258.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_258.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_258.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
