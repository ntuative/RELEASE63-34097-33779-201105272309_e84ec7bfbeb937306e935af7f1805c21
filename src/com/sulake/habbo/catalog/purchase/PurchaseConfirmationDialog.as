package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2268:int = 10;
      ...
      private const const_1986:uint = 4.293848814E9;
      
      private const const_1987:uint = 4.294967295E9;
      
      private const const_1502:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1352 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_317,this.onNameInputKeyUp);
         }
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_308,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_583,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1759 = _loc1_.stuffTypes;
            this.var_877 = _loc1_.boxTypes;
            this.var_879 = _loc1_.ribbonTypes;
            this.var_1353 = this.var_1759[0];
            this.var_401 = this.var_877[0];
            this.var_402 = this.var_879[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_402 < 0)
         {
            this.var_402 = this.var_879.length - 1;
         }
         if(this.var_402 > this.var_879.length - 1)
         {
            this.var_402 = 0;
         }
         if(this.var_401 < 0)
         {
            this.var_401 = this.var_877.length - 1;
         }
         if(this.var_401 > this.var_877.length - 1)
         {
            this.var_401 = 0;
         }
         var _loc1_:int = this.var_877[this.var_401] * 1000 + this.var_879[this.var_402];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1353,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1631 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         {
            _loc4_ = this._catalog.getFurnitureData(_loc3_,ProductTypeEnum.const_82);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1353);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_877[this.var_401]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_879[this.var_402]);
         this._catalog.purchaseProductAsGift(this.var_1630,this.var_1352,this.var_1632,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1630,this.var_1352,this.var_1632);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2930 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_227)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2268)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2930 = _loc2_.text;
      }
      ...
      {
         if(this.var_285 == null || !this.var_285.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_285.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_285 == null)
         {
            this.var_285 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_878 == null)
         {
            this.var_878 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_285 == null || this.var_878 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_285.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_285.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1502;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1986) : uint(this.const_1987);
      }
      ...
      {
         this.var_1353 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1353;
               }
            }
            _loc4_++;
         }
