package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return this.var_1132 + this.var_1132 / -this.var_2971 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_916 - this.var_916 / this.var_591 * this.var_172[param1];
      }
