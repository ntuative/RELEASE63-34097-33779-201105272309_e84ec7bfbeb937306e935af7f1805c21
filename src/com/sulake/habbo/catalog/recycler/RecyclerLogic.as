package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1001:int = 0;
      ...
      {
         return this.var_588 != const_1001;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1671 != RecyclerStatusMessageEvent.const_1281;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_588 == const_447;
      }
      ...
      {
         this.var_588 = const_1000;
         this.var_115 = new Array(const_208);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1671)
         {
            case RecyclerStatusMessageEvent.const_1773:
               this.var_588 = const_447;
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1263:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1738:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_115.length < const_208)
         {
            return false;
         }
         var _loc1_:int = 0;
