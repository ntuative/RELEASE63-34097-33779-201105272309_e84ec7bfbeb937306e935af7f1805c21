package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private static const const_226:String = "wallpaper";
      ...
      private var var_1543:String = "default";
      ...
      private var var_1544:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1016 = this.parseElements(_loc2_.floors.pattern);
         this.var_1269 = this.parseElements(_loc2_.walls.pattern);
         this.var_1268 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1016)
                  {
                     _loc11_ = this.var_1016[_loc10_];
                     if(this.var_667.indexOf(_loc10_) == -1)
                     {
                        this.var_667.push(_loc10_);
                        this.var_1267.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1269[_loc8_] != null)
                  {
                     this.var_816.push(_loc8_);
                     this.var_1270.push(_loc3_);
                  }
                  else
                  {
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1543,this.var_1544,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1270[this.var_461];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1543);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1267[this.var_459];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_458];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1544);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_667[this.var_459];
         var _loc3_:Array = this.var_1016[_loc2_];
         ...
         var _loc4_:Offer = this.var_1267[this.var_459];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_816[this.var_461];
         var _loc6_:Array = this.var_1269[_loc5_];
         if(_loc6_ != null && this.var_457 >= 0)
         {
            _loc13_ = _loc6_[this.var_457];
            if(_loc13_ != null)
            {
               this.var_1543 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1270[this.var_461];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_817[this.var_458];
         var _loc9_:Array = this.var_1268[_loc8_];
         if(_loc9_ != null && this.var_460 >= 0)
         {
            _loc15_ = _loc9_[this.var_460];
            if(_loc15_ != null)
            {
               this.var_1544 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_458];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_110:
               ...
               if(this.var_459 < 0)
               {
                  this.var_459 = this.var_667.length - 1;
               }
               if(this.var_459 >= this.var_667.length)
               {
                  this.var_459 = 0;
               }
               this.var_456 = 0;
               this.var_1017 = 0;
               _loc5_ = this.var_667[this.var_459];
               _loc6_ = this.var_1016[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1017 = _loc6_.length;
               }
            ...
            case const_226:
               ...
               if(this.var_461 < 0)
               {
                  this.var_461 = this.var_816.length - 1;
               }
               if(this.var_461 == this.var_816.length)
               {
                  this.var_461 = 0;
               }
               this.var_457 = 0;
               this.var_1018 = 0;
               _loc7_ = this.var_816[this.var_461];
               _loc8_ = this.var_1269[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1018 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_458 < 0)
               {
                  this.var_458 = this.var_817.length - 1;
               }
               if(this.var_458 >= this.var_817.length)
               {
                  this.var_458 = 0;
               }
               this.var_460 = 0;
               this.var_1019 = 0;
               _loc9_ = this.var_817[this.var_458];
               _loc10_ = this.var_1268[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1019 = _loc10_.length;
               }
