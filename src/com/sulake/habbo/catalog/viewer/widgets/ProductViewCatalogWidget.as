package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_2042:Point;
      
      private var var_554:IItemGridWindow;
      
      private var var_1592:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1054 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1319 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_93 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_2042 = new Point(this.var_93.x,this.var_93.y);
         this.var_554 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1592 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_2043 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1054.text = _loc4_;
         this.var_1319.text = _loc5_;
         this.var_1054.height = this.var_1054.textHeight + 5;
         this.var_1319.y = this.var_1054.y + this.var_1054.height;
         this.var_1319.height = Math.max(130,this.var_1319.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.method_2)
            {
               case Offer.const_495:
                  _loc6_ = this.var_2043.clone();
                  if(this.var_554 != null)
                  {
                     this.var_554.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_554,this.var_1592,this.var_1847);
                     this.var_554.scrollV = 0;
                  }
                  break;
               ...
               case Offer.const_427:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_198:
                        ...
                        _loc6_ = new BitmapData(this.var_93.width,this.var_93.height,false,_loc13_);
                        _loc14_ = null;
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_314,AvatarAction.const_476);
                              _loc16_.appendAction(AvatarAction.const_351,_loc8_.productClassId);
                  ...
                  break;
               default:
                  Logger.log("[ProductViewCatalogWidget] Unknown pricing model" + _loc2_.method_2);
            }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2874)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_93 != null && true)
         {
            ...
            this.var_93.x = this.var_2042.x;
            this.var_93.y = this.var_2042.y;
            if(param3 != null)
            {
