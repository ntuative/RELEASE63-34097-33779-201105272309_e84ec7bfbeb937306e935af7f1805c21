package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_921.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_921 = null;
         }
         if(this.var_922 != null)
         {
            this.var_922.removeEventListener(WindowKeyboardEvent.const_210,this.windowKeyEventProcessor);
            this.var_922 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_921 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_921 != null)
         {
            this.var_921.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_922 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_922 != null)
         {
            this.var_922.addEventListener(WindowKeyboardEvent.const_210,this.windowKeyEventProcessor);
         }
         return true;
      }
