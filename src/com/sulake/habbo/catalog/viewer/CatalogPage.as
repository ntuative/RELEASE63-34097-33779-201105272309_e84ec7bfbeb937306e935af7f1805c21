package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1950:String = "ctlg_";
       
      
      protected var var_2170:XML;
      ...
      private var var_1152:ItemGridCatalogWidget;
      ...
      {
         var _loc2_:String = const_1950 + param1;
         ...
         this.var_2170 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2170) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1838:
               if(this.var_1152 == null)
               {
                  this.var_1152 = new ItemGridCatalogWidget(param1);
                  this.var_36.push(this.var_1152);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1703:
               ...
               break;
            case CatalogWidgetEnum.const_1891:
