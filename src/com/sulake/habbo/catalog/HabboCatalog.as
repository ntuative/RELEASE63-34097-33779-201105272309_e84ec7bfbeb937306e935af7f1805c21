package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_664:uint = 1;
      ...
      private var var_1200:IRoomSession;
      ...
      private var var_141:IMarketPlace;
      ...
      private var var_2680:GiftWrappingConfiguration;
      
      private var var_1238:ClubGiftController;
      
      private var var_534:ClubBuyController;
      
      private var var_801:Map;
      
      private var var_1239:Boolean = false;
      
      private var var_800:IPurchasableOffer;
      
      private var var_1524:IDragAndDropDoneReceiver;
      
      private var var_60:PlacedObjectPurchaseData;
      
      private const const_1959:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1745);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_534.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_182.getKey("client.credits.embed.enabled","HeightMapMessageEvent") == "true";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_801.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_664) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1959;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_1917 = param1.session.isPrivateRoom;
               this.var_1200 = param1.session;
               if(this.var_99 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_141 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1238 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_534 == null)
         {
            this.var_534 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_802 && this.var_802 != "")
         {
            this.var_365.openPage(this.var_802);
            this.var_802 = "";
            this.var_1001 = -1;
         }
         else if(this.var_1001 > -1)
         {
            this.var_365.openPageById(this.var_1001,this.var_1916);
            this.var_1001 = -1;
            this.var_1916 = -1;
            this.var_802 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_70,this.var_111.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2678 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1343);
         }
         this.var_2678 = false;
         if(this.var_214 != null && !this.var_214.disposed)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1238.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_141 != null)
         {
            this.var_141.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_141 != null)
         {
            this.var_141.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_141 != null)
         {
            this.var_141.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2680 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_141.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_801.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_801.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1200 || !this.var_1200.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_218);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_200);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1239 && param1.type == RoomEngineObjectEvent.const_152)
         {
            this.resetPlacedOfferData(true);
            if(this.var_800 == null || this.var_800.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_800.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_60 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_800);
            _loc5_ = this.var_1524;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_344,0.5);
            }
         }
      }
      ...
      public function syncPlacedOfferWithPurchase(param1:IPurchasableOffer) : void
      {
         if(this.var_60)
         {
            if(this.var_60.offerId != param1.offerId)
            {
               this.resetPlacedOfferData();
            }
         }
      ...
      public function resetPlacedOfferData(param1:Boolean = false) : void
      {
         ...
         if(this.var_60 != null)
         {
            if(this.var_60.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_60.roomId,this.var_60.roomCategory,this.var_60.objectId);
            }
            else if(this.var_60.category == RoomObjectCategoryEnum.const_26)
            {
               switch(this.var_60.furniData.name)
               {
                  case "floor":
                  case "wallpaper":
                  case "landscape":
                     ...
                     break;
                  default:
                     this._roomEngine.disposeObjectWallItem(this.var_60.roomId,this.var_60.roomCategory,this.var_60.objectId);
               }
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_60.objectId,this.var_60.category);
            }
            this.var_60.dispose();
            this.var_60 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this.var_60 != null && this.var_60.productClassId == param1.classId)
         {
            if(this.var_60.roomCategory == this._roomEngine.activeRoomCategory && this.var_60.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_60.category;
               _loc4_ = this.var_60.wallLocation;
               _loc5_ = this.var_60.x;
               _loc6_ = this.var_60.y;
               _loc7_ = this.var_60.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_309:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_200);
                     if(this.var_60.extraParameter != _loc8_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_310:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_218);
                     if(this.var_60.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_305:
                     ...
                     if(this.var_60.extraParameter != _loc10_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_664);
            if(_loc1_ != null)
            {
