package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      private var var_387:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_613,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_578,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_602,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_331,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1310 && this.var_1311 && this.var_1584;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_613,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_578,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_602,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_331,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_613:
               this.var_1584 = true;
            ...
            case HabboHelpTutorialEvent.const_578:
               if(this.var_44 != null && this.var_44.id == const_434)
               {
                  this.var_2025 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2355 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_318:
               ...
               if(this.var_387 == null)
               {
                  this.var_387 = new NameChangeView(this);
               }
               this.var_387.showMainView();
               this.prepareForTutorial();
               break;
            case const_434:
         ...
         this._window.height = _loc2_.height + this.var_2353;
         this._window.width = _loc2_.width + this.var_2355;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_35.hideUI();
         this.var_35.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_128));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_44 != null && (this.var_44.id == const_318 || this.var_44.id == const_91))
         {
            this.showView(const_91);
         }
      }
      ...
      {
         this.var_1310 = true;
         if(this.var_44 != null && (this.var_44.id == const_434 || this.var_44.id == const_91))
         {
            this.showView(const_91);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_387.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_574)
         {
            this.var_387.checkedName = _loc2_.name;
         }
         else
         {
            this.var_387.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
