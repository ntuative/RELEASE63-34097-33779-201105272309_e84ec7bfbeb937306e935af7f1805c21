package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1477:uint = 13232628;
      ...
      private var var_1180:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_318;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_521 = param1;
         if(this.var_1804 == this.var_521)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1802 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_769)
         {
            this.var_769 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_769)
            {
               return;
            }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_521);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1096 || param1 == ChangeUserNameResultMessageEvent.var_1097)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1180 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1180.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1477;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_521 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_521);
               break;
