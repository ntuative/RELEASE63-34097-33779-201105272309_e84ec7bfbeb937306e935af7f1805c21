package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1732:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105272303));
         this.var_120 = new Map();
         this.var_120.add(HabboHelpViewEnum.const_1676,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_215,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_494,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_358,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_268,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_388,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_704,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_254,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_120.add(HabboHelpViewEnum.const_1274,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_120.add(HabboHelpViewEnum.const_1203,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_867,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_506.length == 0 || param1 != this.var_351)
            {
               this.var_506.push(this.var_351);
            }
         }
         this.var_351 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1163:
               this.showUI(HabboHelpViewEnum.const_1203);
               break;
            case CallForHelpResultEnum.const_1182:
               this.showUI(HabboHelpViewEnum.const_1274);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_120.getValue(HabboHelpViewEnum.const_215) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_613));
      }
      ...
      {
         return this.var_120.getValue(this.var_351);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2355 = this._window.width - _loc3_.width;
         this.var_2353 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2353;
         this._window.width = _loc1_.width + this.var_2355;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_351 == HabboHelpViewEnum.const_215)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_351 == HabboHelpViewEnum.const_215 || this.var_506.length == 0)
         {
            return;
         }
         if(this.var_350 == null)
