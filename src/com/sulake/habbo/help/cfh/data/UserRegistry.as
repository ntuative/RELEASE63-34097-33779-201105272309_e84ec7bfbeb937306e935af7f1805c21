package com.sulake.habbo.help.cfh.data
{
   ...
   public class UserRegistry
   {
      ...
      private static const const_1622:int = 80;
      ...
      {
         var _loc1_:int = 0;
         while(this.var_567.length > const_1622)
         {
      ...
      {
         var _loc1_:* = null;
         while(this.var_1608.length > 0)
         {
            _loc1_ = this.var_567.getValue(this.var_1608.shift());
            if(_loc1_ != null)
            {
