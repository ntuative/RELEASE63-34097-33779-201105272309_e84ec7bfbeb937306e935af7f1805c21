package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_464:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_164.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_153,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1970,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_164.habboConfiguration.getKey("use.sso","HeightMapMessageEvent") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1970,"/");
         ...
         {
            dispatchEvent(new Event(const_464));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_140.removeEventListener(SSOTicket.const_435,this.onParsedTicketSuccess);
            this.var_140.removeEventListener(SSOTicket.const_353,this.onParsedTicketFailure);
            this.var_140 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_140 = new SSOTicket(this.var_164.assets,_loc3_,_loc2_,param1);
         this.var_140.addEventListener(SSOTicket.const_435,this.onParsedTicketSuccess);
         this.var_140.addEventListener(SSOTicket.const_353,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_140.ticket);
         Logger.log("Has Facebook: " + this.var_140.isFacebookUser);
         if(this.var_140.isFacebookUser)
         {
            this.var_164.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_164.flashClientUrl = this.var_140.flashClientUrl;
         this.var_164.ssoTicket = this.var_140.ticket;
         this.var_140.removeEventListener(SSOTicket.const_435,this.onParsedTicketSuccess);
         this.var_140.removeEventListener(SSOTicket.const_353,this.onParsedTicketFailure);
         this.var_140 = null;
         dispatchEvent(new Event(const_464));
