package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_2956:String;
      
      protected var var_2954:int;
      
      protected var var_2955:int;
      
      protected var var_1639:Array;
      ...
      {
         this.var_2956 = param1.readString();
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1639.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
