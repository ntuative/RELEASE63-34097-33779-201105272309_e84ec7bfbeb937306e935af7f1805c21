package com.sulake.habbo.communication.messages.parser.handshake
{
   ...
   public class SessionParamsMessageParser implements IMessageParser
   {
      ...
      protected var var_2968:Boolean;
      
      protected var var_2966:String;
      
      protected var var_2967:Boolean;
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            switch(_loc4_)
            {
               case 0:
                  ...
                  this.var_2185 = _loc5_ > 0;
                  break;
               case 1:
                  _loc5_ = param1.readInteger();
                  this.var_2184 = _loc5_ > 0;
                  break;
               case 2:
                  _loc5_ = param1.readInteger();
                  this.var_2187 = _loc5_ > 0;
                  break;
               case 3:
                  _loc5_ = param1.readInteger();
                  this.var_2183 = _loc5_ > 0;
                  break;
               case 4:
                  _loc5_ = param1.readInteger();
                  this.var_2186 = _loc5_ > 0;
                  break;
               case 5:
