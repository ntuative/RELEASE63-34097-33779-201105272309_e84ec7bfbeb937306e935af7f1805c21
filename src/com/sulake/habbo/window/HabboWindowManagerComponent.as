package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1434:uint = 1;
      ...
      private var var_942:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_249:Array;
      
      private var var_1433:IEventDispatcher;
      
      private var var_1153:Boolean = false;
      
      private var var_1729:ProfilerOutput;
      
      private var var_1431:ProfilerAgentTask;
      
      private var var_1432:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_942 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_451);
         ...
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_942,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_278 = this._windowContextArray[const_1434];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1729)
            {
               this.var_1729 = new ProfilerOutput(context,this,this.var_942);
            }
            this.var_1729.profiler = _loc3_;
            this.var_1431 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1431);
            this.var_1432 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1432);
            this.var_1153 = true;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1433.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_451 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1433.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         this.var_1433.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1762,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1825,param2.name + ": " + param2.toString());
            }
         }
      }
