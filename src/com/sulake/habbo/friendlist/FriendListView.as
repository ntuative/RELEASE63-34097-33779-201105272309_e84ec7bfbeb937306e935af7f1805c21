package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1435:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2038:FriendListTabsView;
      ...
      private var var_1591:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2038 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1435;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1062 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_251 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_2038.prepare(this.var_1062);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1280,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1127,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_937,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_740,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_937,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_740,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1591 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1591.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2040 == -1 ? 0 : int(this.var_17.height - this.var_2040);
         var _loc4_:int = this.var_2041 == -1 ? 0 : int(this.var_17.width - this.var_2041);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_251.y = Util.getLowestPoint(this.var_17.content);
         this.var_251.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1310,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_937,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1280,false);
         ...
         this.var_2040 = this.var_17.height;
         this.var_2041 = this.var_17.width;
