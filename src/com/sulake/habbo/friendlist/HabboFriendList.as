package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_149:IHabboMessenger;
      ...
      private var var_2545:FriendListLookAndFeel;
      
      private var var_437:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1828:OpenedToWebPopup;
      ...
      private var var_1829:AvatarSearchResults;
      ...
      {
         this.var_2545 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_107 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1829 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_633.stop();
            this.var_633.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_633 = null;
         }
         ...
         if(this.var_149)
         {
            this.var_149.release(new IIDHabboMessenger());
            this.var_149 = null;
         }
         if(this.var_182)
         {
         ...
         if(this.var_920)
         {
            this.var_920.release(new IIDAvatarRenderManager());
            this.var_920 = null;
         }
         if(this.var_960)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1828 = new OpenedToWebPopup(this);
         }
         this.var_1828.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_385);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_319,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_920.createAvatarImage(param1,AvatarScaleType.const_98,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_149 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_107.addCategory(new FriendCategory(FriendCategory.const_1134,this.getText("friendlist.friends")));
         this.var_107.addCategory(new FriendCategory(FriendCategory.const_407,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_633)
         {
            this.var_633 = new Timer(120000);
            this.var_633.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_633.start();
         }
         ...
         {
            _loc5_ = this.var_107.findCategory(FriendCategory.const_407);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_437.findTab(FriendListTab.const_103).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_437.findTab(FriendListTab.const_103);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1829.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_437.findTab(FriendListTab.const_103);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_779 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_779.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_48))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_779.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_46))
         {
