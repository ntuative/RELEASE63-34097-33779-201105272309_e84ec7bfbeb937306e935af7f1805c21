package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_376:int = 100;
      ...
      {
         return Math.ceil(this.var_227.length / const_376);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_956 * const_376;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_956 + 1) * const_376,this.var_227.length);
      }
