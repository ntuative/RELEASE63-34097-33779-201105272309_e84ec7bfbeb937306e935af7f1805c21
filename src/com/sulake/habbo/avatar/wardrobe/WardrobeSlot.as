package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_690 && this.var_1597)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_98,this.var_1056,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_35,parseInt(FigureData.const_808));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1597 && this.var_690 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_690 = this._controller.figureData.getFigureString();
               this.var_1056 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_2053,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_690)
               {
                  this._controller.loadAvatarInEditor(this.var_690,this.var_1056,this._controller.clubMemberLevel);
               }
         }
      }
