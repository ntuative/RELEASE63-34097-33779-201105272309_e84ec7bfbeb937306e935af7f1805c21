package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1194:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2502:IStructureData;
      
      private var var_1812:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         this.var_2502.appendXML(this.var_1812);
         dispatchEvent(new Event(AvatarStructureDownload.const_1194));
      }
