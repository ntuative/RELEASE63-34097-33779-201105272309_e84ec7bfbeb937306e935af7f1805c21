package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_792:IFigurePartSet;
      ...
      private var var_647:Rectangle;
      
      private var var_1869:int = 0;
      
      private var var_446:IAvatarRenderManager;
      
      private var var_1102:Boolean;
      
      private var var_1870:BitmapData;
      
      private const const_2243:int = 13421772;
      
      private const const_2242:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_709 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1869 = Math.max(this.var_1869,_loc6_.colorLayerIndex);
            }
         }
         this.var_446 = this.var_72.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_709 != null && !this.var_1868)
            {
               _loc3_ = this.var_709;
            }
            else
         ...
         if(this.isSelected)
         {
            this.var_1503.color = this.const_2243;
         }
         else
         {
            this.var_1503.color = this.const_2242;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:IAvatarFigureContainer = this.var_446.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         Logger.log("QUERYING SET:" + this.partSet.type + "-" + this.partSet.id);
         if(!this.var_446.isFigureReady(_loc1_))
         {
            this.var_446.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               ...
               _loc4_ = this.var_446.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_647 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1870)
               {
                  ...
                  this.var_1870 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_647.width,this.var_647.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_647.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_647.y;
               if(this.var_1868 && _loc2_.colorLayerIndex > 0)
               {
