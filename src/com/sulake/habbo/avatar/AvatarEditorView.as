package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1637:IWindowContainer;
      
      public static var var_2146:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1174 = [];
         this.var_1464 = [AvatarEditorFigureCategory.const_801,AvatarEditorFigureCategory.const_53,AvatarEditorFigureCategory.const_278,AvatarEditorFigureCategory.const_720,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_109];
         super();
         ...
         if(var_1357 == null)
         {
            ...
            var_1357 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1637 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1637 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_434 = new Timer(1000);
         this.var_434.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1464;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_434.stop();
            this.var_434.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_434 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1174.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1174.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2458 = this.canChangeOutfit();
            this.var_434.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1174.indexOf(_loc4_.name) < 0)
            {
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_46) && (this.var_1786 == AvatarEditorSideCategory.const_109 || this.var_2459))
         {
      ...
      {
         if(this.var_1786 == AvatarEditorSideCategory.const_109)
         {
            this.var_2459 = false;
            this.setSideContent(AvatarEditorSideCategory.const_702);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_702:
               break;
            case AvatarEditorSideCategory.const_528:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_528);
               break;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2457 = new Date().valueOf();
                  this.var_2458 = false;
                  this.var_434.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_518)
         {
            ...
            this.var_518 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_518.procedure = this.stripClubDialogEventProc;
            this.var_518.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2457 > 5000;
      }
   }
}
