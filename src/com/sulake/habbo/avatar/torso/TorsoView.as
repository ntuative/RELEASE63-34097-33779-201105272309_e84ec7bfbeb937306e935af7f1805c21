   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_240,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_190,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_267,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_72 && var_155 == "")
         {
            var_72.switchCategory(FigureData.const_190);
         }
      }
