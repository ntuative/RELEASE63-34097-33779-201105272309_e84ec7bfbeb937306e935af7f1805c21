package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_302:PetDataManager;
      
      private var var_762:PaletteManager;
      ...
      private var var_1783:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_336 = RenderMode.const_1797;
         ...
         this.var_109.add(AvatarType.const_130,_loc4_);
         ...
         this.var_109.add(AvatarType.const_55,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_302 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_762 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_302.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_302.init();
         this.var_762.init();
         _loc2_ = this.var_109.getValue(AvatarType.const_130) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_109.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_109.getValue(AvatarType.const_130) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1194,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_992)
         {
            if(this.var_2451 && this.var_2453 && this.var_2452)
            {
               this.var_992 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_109.getValue(AvatarType.const_130) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1783)
         {
            this.var_1783 = new AvatarFigureContainer(this.const_2235);
         }
         this.var_226.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1783,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc2_ in this.var_301.getKeys())
         {
            _loc3_ = this.var_301.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_302.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1788)
         {
            _loc6_ = !this.var_302.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_302.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_109.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_302.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_109.getValue(AvatarType.const_55);
      ...
      {
         var _loc3_:AvatarStructure = this.var_109.getValue(AvatarType.const_130) as AvatarStructure;
      ...
      {
         return this.var_302 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_55:
               _loc3_ = this.var_109.getValue(AvatarType.const_55) as AvatarStructure;
               break;
            default:
