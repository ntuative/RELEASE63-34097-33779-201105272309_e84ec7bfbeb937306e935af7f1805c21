package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_1397:IAvatarImage;
      ...
      private var var_418:AvatarImageBodyPartContainer;
      
      private var var_1530:String;
      
      private var var_125:AvatarImagePartContainer;
      
      private var var_2696:Point;
      ...
      private var var_2694:ByteArray;
      
      private var var_2695:ImageData;
      
      private var var_1094:PaletteMap;
      
      private var var_1007:Array;
      
      private var var_1006:Point;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_267.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_267.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_267.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_267.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_267.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_267.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_806 == GeometryType.const_1241 && param1 == GeometryType.const_1236 || this.var_806 == GeometryType.const_1236 && param1 == GeometryType.const_1241)
         {
            this.var_806 = param1;
            this.var_90 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_267.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_367.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_984)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_610)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1397.getFigure(),_loc5_,this.var_806,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_418 = _loc10_.getImageContainer(_loc4_);
         if(this.var_418 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_418 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_367);
            if(this.var_418 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_418,_loc4_);
         }
         this.var_418.offset = _loc8_;
         return this.var_418;
      }
      
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_267.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_267.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_90)
         {
            this.var_90 = this._structure.getCanvas(this._scale,this.var_806);
            if(!this.var_90)
            {
               return null;
            }
            this.var_2696 = new Point(0,this.var_90.height - int(this.var_90.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1847[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_895 || _loc10_ == AvatarAction.const_408;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1530 = this.var_125.bodyPartId;
               this.var_189 = this.var_125.partType;
               this.var_1930 = this.var_125.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_125.method_9 != this.var_189)
                     {
                        this.var_189 = this.var_125.method_9;
                     }
                  }
               }
               this.var_1529 = this._scale + "_" + this.var_125.action.assetPartDefinition + "_" + this.var_189 + "_" + this.var_1930 + "_" + _loc5_ + "_" + this._frame;
               this.var_454 = this._assets.getAssetByName(this.var_1529) as BitmapDataAsset;
               if(this.var_454 == null)
               {
                  this.var_1529 = this._scale + "_std_" + this.var_189 + "_" + this.var_1930 + "_" + _loc5_ + "_0";
                  this.var_454 = this._assets.getAssetByName(this.var_1529) as BitmapDataAsset;
               }
               if(!(!this.var_454 || !this.var_454.content))
               {
                  ...
                  {
                     this.var_1094 = this._structure.renderManager.paletteManager.getPalette(this.var_125.paletteMapId);
                     if(this.var_1094 != null)
                     {
                        this.var_1008 = this.var_454.content as BitmapData;
                        this.var_190 = new BitmapData(this.var_1008.width,this.var_1008.height);
                        this.var_2694 = this.var_1094.colorize(this.var_1008.getPixels(this.var_1008.rect));
                        this.var_190.setPixels(this.var_190.rect,this.var_2694);
                     }
                     else
                     {
                        this.var_190 = (this.var_454.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1530 == AvatarBodyPartType.const_278 || this.var_1530 == AvatarBodyPartType.const_1770 || this.var_1530 == AvatarBodyPartType.const_1836) && this.var_125.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_190.colorTransform(this.var_190.rect,_loc18_);
                  }
                  else if(this.var_125.isColorable && this.var_125.color != null)
                  {
                     this.var_190.colorTransform(this.var_190.rect,this.var_125.color.colorTransform);
                  }
                  if(this.var_125.isBlendable)
                  {
                     this.var_190.colorTransform(this.var_190.rect,this.var_125.blendTransform);
                  }
                  this.var_1006 = this.var_454.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_56)
                     {
                  ...
                  this.var_2695 = new ImageData(this.var_190,this.var_1006,_loc7_);
                  this.var_1007.push(this.var_2695);
               }
            }
            _loc8_--;
         }
         if(this.var_1007.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_1007,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2696.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_56)
            {
         ...
         _loc8_ = this.var_1007.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1007.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
