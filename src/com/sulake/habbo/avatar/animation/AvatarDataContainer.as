package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1683:Number = 1.0;
      ...
      {
         super();
         this.var_1814 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2505 = parseInt(_loc2_,16);
         this.var_2506 = parseInt(_loc3_,16);
         ...
         this.var_832 = new ColorTransform(this.var_1680,this.var_1683,this.var_1681,this._alphaMultiplier);
         this.var_1184 = this.generatePaletteMapForGrayscale(this.var_2506,this.var_2505);
      }
      ...
      {
         return this.var_1184.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1184.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1184.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1184.getValue("alphas") as Array;
      }
