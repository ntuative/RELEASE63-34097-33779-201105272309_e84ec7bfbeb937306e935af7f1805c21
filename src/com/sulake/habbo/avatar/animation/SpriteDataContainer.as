package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2702:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1814 = parseInt(param2.@ink);
         this.var_2700 = String(param2.@member);
         this.var_2701 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1531 = [];
         this.var_1532 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1532[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1532.length)
         {
            return this.var_1532[param1];
         }
         return 0;
      }
