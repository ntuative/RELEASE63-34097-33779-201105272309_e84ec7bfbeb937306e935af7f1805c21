package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1679:int = 1;
      ...
      {
         return this.visible && this._window.getStateFlag(WindowState.const_85);
      }
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_997)
            {
               this.var_997.addChild(this._window);
            }
