package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_780 = [];
         this.var_780.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_780.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_780.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_643 = _loc3_.currentSongId != -1;
         ...
         this.var_1989 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_102,HabboMusicPrioritiesEnum.const_125,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_825.indexOf(_loc5_) < 0)
               {
                  this.var_825.push(_loc5_);
                  this.var_239.requestSongInfoWithoutSamples(_loc5_);
               }
            }
            _loc7_.diskId = _loc6_;
            this.var_548.push(_loc7_);
            _loc4_++;
         }
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_548[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_825.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_825.splice(_loc3_,1);
         }
         if(this.var_825.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_101));
