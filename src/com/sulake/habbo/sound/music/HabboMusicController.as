package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1626:int = HabboMusicPrioritiesEnum.const_125;
      ...
      private var var_571:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_976,this.onJukeboxInit);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_283,this.onJukeboxDispose);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_827,this.onSoundMachineInit);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_785,this.onSoundMachineDispose);
         this.var_1342 = new Timer(1000);
         this.var_1342.start();
         this.var_1342.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_288)
         {
            this.var_329[_loc6_] = null;
            this.var_862[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2096)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_393)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_281)
            {
               ...
               {
                  _loc3_ = this.var_281.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_976,this.onJukeboxInit);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_283,this.onJukeboxDispose);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_827,this.onSoundMachineInit);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_785,this.onSoundMachineDispose);
            }
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_281.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_288)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_699.add(param1,param2);
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_281.length)
         {
            ...
            if(_loc3_.id != this.var_1613 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         while(_loc2_ < this.var_329.length)
         {
            if(this.var_329[_loc2_] != null)
            {
               ...
               _loc4_ = this.var_281.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_863));
         Logger.log("Requested song info\'s : " + this.var_863);
         this.var_863 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_281.add(_loc6_.id,_loc10_);
               ...
               while(this.var_864.indexOf(_loc6_.id) != -1)
               {
                  this.var_864.splice(this.var_864.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_288)
         {
            return false;
         }
         ...
         this.var_2096 = this.getSongRequestCountAtPriority(param1);
         this.var_1613 = param2;
         if(this._priorityPlaying <= const_1626)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2911 != param1.id || _loc3_ > this.var_2912 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2911 = param1.id;
            this.var_2912 = _loc3_;
         }
      }
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_699.getValue(param1);
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_571 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_86,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_571 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
