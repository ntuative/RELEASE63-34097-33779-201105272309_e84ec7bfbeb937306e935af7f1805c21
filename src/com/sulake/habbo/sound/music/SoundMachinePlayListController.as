package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_239 = param2;
         this.var_780 = [];
         this.var_780.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_780.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_780)
         {
         ...
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_953,this.onSoundMachinePlayEvent);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_990,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_953,this.onSoundMachinePlayEvent);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_990,this.onSoundMachineStopEvent);
               this.var_86 = null;
            }
            this._disposed = true;
         }
