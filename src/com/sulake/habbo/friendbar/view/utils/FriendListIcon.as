package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      private static const const_1062:int = 200;
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1062) : int(const_1061));
         if(!var_888 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_888,!!_hover ? int(const_1062) : int(const_1061));
         if(!var_888 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
