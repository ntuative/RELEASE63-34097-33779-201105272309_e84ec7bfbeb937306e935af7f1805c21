package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1962:String = "title";
      
      private static const BUTTON:String = "button";
      
      private static const const_1454:String = "addFriendsTabXML";
      
      private static const const_1455:String = "add_friends_icon_png";
      
      private static var var_950:int = -1;
      ...
      {
         var _loc1_:IWindowContainer = false ? const_452.pop() : var_1356.buildFromXML(var_886.getAssetByName(const_1454).content as XML) as IWindowContainer;
         var _loc2_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_666));
         ...
         if(var_950 < 0)
         {
            var_950 = _loc1_.height;
         }
         _loc1_.height = name_1;
         var _loc3_:IBitmapWrapperWindow = _loc1_.findChildByName(const_1006) as IBitmapWrapperWindow;
         _loc3_.disposesBitmap = false;
         _loc3_.bitmap = var_886.getAssetByName(const_1455).content as BitmapData;
