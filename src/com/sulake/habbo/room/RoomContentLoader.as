package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_942:String = "RCL_LOADER_READY";
      
      private static const const_365:String = "RCL_PUBLICROOM_";
      
      private static const const_1963:int = 0;
      ...
      private static const const_653:String = "wall_place_holder";
      
      private static const const_652:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_453;
      
      private static const const_654:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1025:String = "selection_arrow";
      ...
      private var var_1447:IEventDispatcher = null;
      ...
      private var var_952:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_953:Map = null;
      
      private var var_206:PublicRoomData = null;
      
      private var var_1448:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2411 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2410 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1026)
         {
            return;
         }
         this.var_1447 = param1;
         this.var_2409 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2407 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_952.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_510.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_510.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_431 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_431.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_758.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_432.add(_loc3_,_loc4_);
               if(this.var_355[_loc7_] == null)
               {
                  this.var_355[_loc7_] = 1;
               }
            }
            ...
            _loc8_ = this.var_609.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_609.remove(_loc7_);
               this.var_609.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2408)
         {
            ...
            {
               this.var_1447.dispatchEvent(new Event(const_942));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_511 != null)
         {
            ...
            this.var_511.add(param1,param2);
         }
         if(this.var_512 != null)
         {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_355;
         }
         return RoomObjectCategoryEnum.const_183;
      }
      ...
      {
         return [const_453,const_653,const_652,const_654,TILE_CURSOR,const_1025];
      }
      ...
      {
         var _loc3_:String = this.var_608.getValue(param1) as String;
      ...
      {
         return this.var_952.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_953[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_758.getValue(param1) != null)
         {
            return this.var_758.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_206 != null && this.var_206.hasWorldType(const_365 + param1))
         {
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_609.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_355[_loc4_] == null)
                     {
                        this.var_355[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1448.getValue(param1) != null)
         {
            this.var_206 = this.var_1448.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_879,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2411.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2410.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_616,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_953.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1448.add(param1,_loc4_);
         this.var_206 = _loc4_;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_510.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_510.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_510.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_537.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_431.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_431.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_431[_loc2_] != null)
         {
            _loc3_ = this.var_431.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_365 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_365 + param1) == RoomObjectCategoryEnum.const_79)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_206.getWorldHeightScale(const_365 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_206 != null)
         {
            return this.var_206.getWorldScale(const_365 + param1);
         }
         return 32;
      }
