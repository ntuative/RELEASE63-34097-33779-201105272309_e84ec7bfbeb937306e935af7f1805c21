package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1441:String = "head";
      
      private static const const_651:int = 1;
      
      private static const const_1022:int = 1000;
      
      private static const const_1444:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1444) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_352 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2387)
            {
               this.var_2387 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_154)
         {
            ...
            this.var_2051 = _loc3_.getNumber(RoomObjectVariableEnum.const_415) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_222);
            if(!isNaN(_loc8_))
            {
            ...
            this.var_1403 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2280 = _loc3_.getNumber(RoomObjectVariableEnum.const_818);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_878);
            if(_loc9_ != this.var_1758)
            {
               this.var_1758 = _loc9_;
               this.var_2386 = this.var_1758.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_352 != null)
         {
            ...
            if(this.var_1403 > 0)
            {
               _loc2_ = param1 - this.var_1403;
               if(_loc2_ < const_1022)
               {
                  this.var_352.alpha = int(Math.sin(_loc2_ / const_1022 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_352.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_352.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_651;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2386);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_651)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_651))
            {
      ...
      {
         if(this.var_948[param1] == null)
         {
            if(this._animationData.getTag(var_95,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1441)
            {
               this.var_948[param1] = true;
            }
            else
            {
               this.var_948[param1] = false;
            }
         }
