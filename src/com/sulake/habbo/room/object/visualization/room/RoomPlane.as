package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1089:IPlaneRasterizer = null;
      
      private var var_823:PlaneMaskManager = null;
      ...
      private var var_478:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2934 = param9;
         this.var_2937 = param10;
         this.var_2935 = param11;
         this.var_2936 = param12;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1089.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_478;
         if(_loc3_ == null)
         {
         ...
         if(this.var_880 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_405))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_300.length * param1.scale;
            _loc6_ = this.var_299.length * param1.scale;
            ...
            if(this.var_1089 != null)
            {
               _loc3_ = this.var_1089.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2124,this.var_2934,this.var_2937,this.var_2935,this.var_2936,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1726 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1579.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1579[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1148);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_157.z - originZ,this.var_117.z - originZ,this.var_89.z - originZ,this.var_118.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2336 = relativeDepth;
            this._isVisible = true;
            this.var_1726 = geometry.updateId;
         }
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1091)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_404.length)
            {
               _loc5_ = this.var_404[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_286.length == this.var_1090.length)
         {
            while(_loc1_ < this.var_286.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_1090[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_404.length > this.var_1633.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1091 || this.var_286.length == 0 && this.var_404.length == 0 && !this.var_405 || this.var_823 == null)
         {
            return;
         }
         ...
         if(this.var_405)
         {
            ...
            while(_loc5_ < this.var_286.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_75.width - this.var_75.width * _loc3_.leftSideLoc / this.var_300.length;
                  _loc11_ = this.var_75.height - this.var_75.height * _loc3_.rightSideLoc / this.var_299.length;
                  _loc12_ = _loc3_.type;
                  this.var_823.updateMask(this.var_75,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1090.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_404.length)
            {
               _loc4_ = this.var_404[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_75.width - this.var_75.width * _loc4_.leftSideLoc / this.var_300.length;
                  _loc11_ = this.var_75.height - this.var_75.height * _loc4_.rightSideLoc / this.var_299.length;
                  _loc13_ = this.var_75.width * _loc4_.leftSideLength / this.var_300.length;
                  _loc14_ = this.var_75.height * _loc4_.rightSideLength / this.var_299.length;
                  this.var_75.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1633.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_405 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_244.copyChannel(param1,param1.rect,const_682,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_244.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_244,this.var_244.rect,const_682,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
