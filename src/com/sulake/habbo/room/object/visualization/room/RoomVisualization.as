package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1817:int = 16777215;
      
      public static const const_1808:int = 13421772;
      ...
      public static const const_1813:int = 16777215;
      
      public static const const_1725:int = 13421772;
      
      public static const const_1848:int = 10066329;
      ...
      private var var_809:Rectangle = null;
      
      private var var_538:RoomPlaneBitmapMaskParser = null;
      
      private var var_1543:String = null;
      
      private var _floorType:String = null;
      
      private var var_1544:String = null;
      
      private var _floorThicknessMultiplier:Number = NaN;
      
      private var var_1427:Number = NaN;
      
      private var var_1941:String = null;
      
      private var var_1245:uint = 16777215;
      
      private var var_2707:int = 255;
      
      private var var_2705:int = 255;
      ...
      private var var_2036:int = -1000;
      
      private const const_2258:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_538 = new RoomPlaneBitmapMaskParser();
         this.var_314["null"] = false;
         this.var_314["null"] = true;
         this.var_314["null"] = true;
         this.var_314["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_142 != null)
         {
            ...
            {
               _loc2_ = this.var_142[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_809 = super.boundingRectangle;
         }
         return new Rectangle(this.var_809.x,this.var_809.y,this.var_809.width,this.var_809.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_142.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_142[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1427;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1272);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1151);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_440)
            {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_440)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2036 + this.const_2258 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_369.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1940)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2706 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2705 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2707 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1726)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1423 || _loc3_.y != this.var_2335 || _loc3_.z != this.var_2338 || param1.scale != this.var_1942))
            {
               this.var_1423 = _loc3_.x;
               this.var_2335 = _loc3_.y;
               this.var_2338 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_154 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_1941)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1941 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_863));
            if(_loc4_ != this.var_1245)
            {
               this.var_1245 = _loc4_;
               this.var_2706 = this.var_1245 & 255;
               this.var_2705 = this.var_1245 >> 8 & 255;
               this.var_2707 = this.var_1245 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1167));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_154 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_218);
            ...
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_902));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_154 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1142);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1179);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1427))
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_142.length)
         {
            _loc5_ = this.var_142[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_314["null"] || param2 != this.var_314["null"] || param3 != this.var_314["null"])
         {
            this.var_314["null"] = param1;
            this.var_314["null"] = param2;
            this.var_314["null"] = param3;
            this.var_369 = [];
            this.var_663 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_314[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1246;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_538.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_142.length)
         {
            _loc3_ = this.var_142[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_538.maskCount)
         {
            _loc10_ = this.var_538.getMaskType(_loc8_);
            _loc11_ = this.var_538.getMaskLocation(_loc8_);
            _loc12_ = this.var_538.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_142.length)
               {
                  _loc3_ = this.var_142[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_72 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_255)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_142[_loc18_] as RoomPlane;
