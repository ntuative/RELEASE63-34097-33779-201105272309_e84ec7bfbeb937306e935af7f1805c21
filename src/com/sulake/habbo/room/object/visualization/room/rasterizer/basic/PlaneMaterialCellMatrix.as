package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1856:int = const_406;
      ...
      private var var_2515:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2514:Number = -1.0;
         ...
         if(this.isStatic)
         {
            if(this.var_32 != null)
            {
               if(this.var_32.width == param2 && this.var_32.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_664,param6,param7);
                     return param1;
                  }
                  return this.var_32;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_32.width,this.var_664);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_32.height - this.var_664,this.var_32.width,this.var_664);
         }
