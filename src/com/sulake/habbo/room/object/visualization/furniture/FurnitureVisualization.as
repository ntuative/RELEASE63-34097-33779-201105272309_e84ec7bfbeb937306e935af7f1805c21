package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1957:Number = Math.sqrt(0.5);
      ...
      private var var_2855:Number = 0.0;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_587 != spriteCount)
         {
            createSprites(this.var_587);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2222;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_389:
               break;
            case LayerData.const_1279:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1166:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_486 != _loc3_.getUpdateID() || param1 != var_95 || param2 != this.var_2856)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2853 = _loc3_.getNumber(RoomObjectVariableEnum.const_277);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_344));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1309 = this.getAdClickUrl(_loc3_);
            if(this.var_1309 == null || this.var_1309.indexOf("http") != 0)
            {
               this.var_1309 = null;
            }
            this.var_2222 = this.var_1309 != null;
            this.var_2852 = _loc3_.getNumber(RoomObjectVariableEnum.const_888);
      ...
      {
         if(this.var_2857 != param2 || this.var_2855 != param1)
         {
            this.var_1050 = [];
            this.var_1051 = [];
            this.var_844 = [];
            ...
            this.var_2854 = this.getSize(param1);
      ...
      {
         this.var_587 = param1;
         this.var_1583 = this.var_587 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_1050[param2];
         var _loc4_:Boolean = this.var_1051[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2854;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1583)
            {
      ...
      {
         if(this.var_838[param3] != null && !this.var_2024)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2852 * (param1 / 2));
      }
