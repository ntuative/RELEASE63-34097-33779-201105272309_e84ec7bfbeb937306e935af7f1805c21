package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_250:IRoomObjectSprite;
      ...
      private var var_1159:Number = 1.0;
      
      private var var_603:BitmapData;
      
      private var var_746:ColorTransform;
      
      private var var_1438:ColorTransform;
      
      private var var_1750:Matrix;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_746 = new ColorTransform();
         this.var_746.alphaMultiplier = 1;
         this.var_1438 = new ColorTransform();
         this.var_1750 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_103 = this.var_1158[param1];
         this.var_944 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1749 >= 0)
         {
            this.var_250 = this._visualization.getSprite(this.var_1749);
            if(this.var_250 && this.var_250.asset)
            {
               if(this.var_250.width <= 1 || this.var_250.height <= 1)
               {
                  return;
               }
               if(this.var_90 == null)
               {
                  this.var_90 = this.var_250.asset.clone();
                  if(this.var_746.alphaMultiplier != 1)
                  {
                     this.var_603 = new BitmapData(this.var_90.width,this.var_90.height,true,4278190080);
                  }
               }
               this.var_2264 = -this.var_250.offsetX;
               this.var_2263 = -this.var_250.offsetY;
               this.var_250.asset = this.var_90;
            }
            if(this.var_90)
            {
            ...
            if(this.var_603)
            {
               this.var_603.fillRect(this.var_603.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_103.y * this.var_1159;
         }
         return 0;
      }
      ...
      {
         if(!this.var_103 || !this.var_250)
         {
            return;
         }
         if(this.var_90 && this.var_250.asset != this.var_90)
         {
            this.var_250.asset = this.var_90;
         }
         if(this.var_944)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_944 && this.var_103.hasIgnited)
         {
            this.var_944 = true;
         }
         _loc8_ = this.var_1171 * this.var_1159;
         this.var_103.update();
         if(this.var_944)
         {
            if(this.var_103.roomObjectSpriteId >= 0)
            ...
            {
               this.var_90.draw(this.var_603,this.var_1750,this.var_746,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_103.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2264 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1159;
               _loc4_ = this.var_2263 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1159;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1438.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_90.draw(_loc7_,this._translationMatrix,this.var_1438,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         for each(_loc3_ in param1.emitter)
         {
            ...
            for each(_loc23_ in _loc3_.particles.particle)
            {
               ...
               _loc19_ = _loc23_.@is_emitter == "HeightMapMessageEvent" ? false : true;
               ...
               _loc7_.method_15(_loc18_,_loc19_,_loc21_,_loc20_);
            }
