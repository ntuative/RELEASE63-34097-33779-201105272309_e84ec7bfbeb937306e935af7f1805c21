package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1717:String = "plane";
      
      public static const const_1814:String = "sphere";
      ...
      private var var_988:Number = 0.1;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_264 = param6;
         this.var_2613 = param7;
         this.var_2618 = param9;
         this._energy = param8;
         this.var_2616 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_989 = 0;
         this.var_944 = false;
         this.init(0,0,0,this._direction,this.var_2615,this.var_988,this.var_2618,true);
      }
      
      public function method_15(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2617)
         {
            switch(this.var_2613)
            {
               case const_1706:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_988,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_989 < this.var_1507)
         {
            if(this.age % this.var_2616 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_989 < this.var_1507)
         {
            ...
            this.y = (2 - this.var_264) * this.y - (1 - this.var_264) * this.lastY + this.var_1881 * this.var_988 * this.var_988;
         ...
         for each(_loc2_ in this.var_363)
         {
            ...
            _loc2_.y = (2 - this.var_264) * _loc2_.y - (1 - this.var_264) * _loc2_.lastY + this.var_1881 * this.var_988 * this.var_988;
