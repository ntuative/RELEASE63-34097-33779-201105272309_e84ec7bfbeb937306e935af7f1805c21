package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1550:Number = 30;
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         this.var_2704 = param4 * 0 * 2 / 360;
         this.var_1938 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1243 = 0;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1243 += this.var_2704 / const_1550;
      ...
      {
         var _loc3_:Number = this.var_1450 * Math.cos(this.var_1243 + this.var_1938);
         var _loc4_:Number = this.var_1450 * Math.sin(this.var_1243 + this.var_1938);
