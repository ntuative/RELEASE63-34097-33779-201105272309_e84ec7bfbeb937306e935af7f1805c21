package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_378:int = 1000;
      ...
      private var var_1212:DirectionData = null;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1279);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1166);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         {
            _loc6_ = int(this.var_262.getKey(_loc5_)) * this.var_1498;
