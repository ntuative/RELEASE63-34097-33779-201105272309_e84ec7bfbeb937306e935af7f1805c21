package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1491:uint = 16777215;
      
      private var var_1836:int = 255;
      
      private var var_1205:uint = 16777215;
      
      private var var_1839:int = 255;
      
      private var var_1206:int = 0;
      
      private var var_1837:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_565,RoomObjectMouseEvent.const_154];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1272,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_863,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_809,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_902,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1206)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1838;
            if(_loc2_ - this.var_1206 >= this.var_1837)
            {
               _loc3_ = this.var_1205;
               _loc4_ = this.var_1839;
               this.var_1206 = 0;
            }
            else
            {
               _loc7_ = this.var_1491 >> 16 & 255;
               _loc8_ = this.var_1491 >> 8 & 255;
               _loc9_ = this.var_1491 & 255;
               _loc10_ = this.var_1205 >> 16 & 255;
               _loc11_ = this.var_1205 >> 8 & 255;
               _loc12_ = this.var_1205 & 255;
               _loc13_ = (_loc2_ - this.var_1206) / this.var_1837;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1836 + (this.var_1839 - this.var_1836) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_863,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_855:
               param2.setString(RoomObjectVariableEnum.const_200,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_548:
               ...
               this.var_538.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_782:
               _loc4_ = this.var_538.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_538.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1149:
               param2.setNumber(RoomObjectVariableEnum.const_809,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1244:
               param2.setNumber(RoomObjectVariableEnum.const_902,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_649:
               param2.setNumber(RoomObjectVariableEnum.const_1142,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1246:
               param2.setNumber(RoomObjectVariableEnum.const_1179,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1167,int(param1.bgOnly));
         this.var_1491 = this._color;
         this.var_1836 = this.var_1838;
         this.var_1205 = _loc3_;
         this.var_1839 = _loc4_;
         this.var_1206 = getTimer();
         this.var_1837 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_588,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1806,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1744,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1818,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_588,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_233 || _loc12_ == RoomPlaneData.const_440)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
