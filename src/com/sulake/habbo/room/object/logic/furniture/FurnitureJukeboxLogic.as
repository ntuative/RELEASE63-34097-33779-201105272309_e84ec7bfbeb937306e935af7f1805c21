package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_477,RoomObjectFurnitureActionEvent.const_590,RoomObjectFurnitureActionEvent.const_598,RoomObjectFurnitureActionEvent.const_536,RoomObjectWidgetRequestEvent.const_169];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_754) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_404,RoomWidgetInfostandExtraParamEnum.const_551);
            ...
            if(_loc4_ != this.var_2229)
            {
               this.var_2229 = _loc4_;
               if(_loc4_ == 1)
               {
