package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_2007 = _loc2_;
            this.var_2824 = param1.extra;
            this.var_1293 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1293 > 0 && param1 >= this.var_1293)
         {
            this.var_1293 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2007,String(this.var_2007),this.var_2824);
