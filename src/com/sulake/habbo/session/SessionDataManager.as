package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_2993:Array;
      
      private var var_2003:GroupDetailsView;
      ...
      private var var_681:ProductDataParser;
      ...
      private var var_2002:UserTagManager;
      
      private var var_1290:BadgeImageManager;
      
      private var var_1292:HabboGroupInfoManager;
      
      private var var_1042:IgnoredUsersManager;
      ...
      private var var_1288:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_2993 = [];
         this.var_2002 = new UserTagManager(events);
         this.var_1292 = new HabboGroupInfoManager(this,events);
         this.var_1042 = new IgnoredUsersManager(this);
         this.var_1288 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_320)
         {
            this.var_320.removeEventListener(FurnitureDataParser.const_124,this.onFurnitureReady);
            this.var_320.dispose();
            this.var_320 = null;
         }
         if(this.var_681)
         {
            this.var_681.removeEventListener(ProductDataParser.const_124,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1290 = new BadgeImageManager(context.root.assets,events,this.var_182,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_2002.communication = this._communication;
         this.var_1292.communication = this._communication;
         this.var_1288.communication = this._communication;
         this.var_1042.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_320)
         {
            ...
            this.var_320 = new FurnitureDataParser(this.var_552,this._wallItems,this.var_551,this._localization);
            this.var_320.addEventListener(FurnitureDataParser.const_124,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2004 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2444 = _loc3_.respectTotal;
         this.var_1291 = _loc3_.respectLeft;
         this._petRespectLeft = _loc3_.petRespectLeft;
         this.var_690 = _loc3_.figure;
         this.var_1056 = _loc3_.sex;
         this.var_1894 = _loc3_.realName;
         this.var_2725 = _loc3_.identityId;
         this.var_1042.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_690 = _loc2_.figure;
            this.var_1056 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_690,this.var_1056));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2819 = _loc2_.isOpen;
         this.var_2818 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_2004 >= SecurityLevelEnum.const_1233;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_2002.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1290.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1290.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_2003 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1292.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_2003.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1292.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1292.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1290.getBadgeImage(param1,BadgeImageManager.const_1209);
      }
      ...
      {
         return this.var_1042.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1042.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1042.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1291 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1291 = this.var_1291 - 1;
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_551.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1289.indexOf(param1) == -1)
         {
         ...
         if(this.var_681 == null)
         {
            ...
            this.var_681 = new ProductDataParser(_loc2_,this.var_1272);
            this.var_681.addEventListener(ProductDataParser.const_124,this.onProductsReady);
         }
         return false;
      }
