package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_536:UserInfoCtrl;
      
      private var var_1242:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(this.var_69.windowManager == null || this.var_69.assets == null)
         {
            return;
         }
         var _loc1_:XmlAsset = this.var_69.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         this._window = this.var_69.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._window == null)
         {
            return;
         }
         ...
         this.var_69.disableButton(this.var_69.initMsg.chatlogsPermission,this._window,"show_chatlog");
         ...
         this.var_536 = new UserInfoCtrl(this._window,this.var_69,_loc3_.message);
         this.var_1242 = new UserInfoCtrl(this._window,this.var_69,_loc3_.message);
         this.var_536.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1242.load(_loc4_,this.var_166.reportedUserId);
         }
         else
         {
      ...
      private function updateIssueList() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc9_ = this.var_69.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
            if(_loc9_ == null || _loc9_.content == null)
            {
               return;
            }
            _loc4_ = this.var_69.windowManager.buildFromXML(_loc9_.content as XML) as IWindowContainer;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      private function updateMessages() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc8_ = this.var_69.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
            if(_loc8_ == null || _loc8_.content == null)
            {
               return;
            }
            _loc4_ = this.var_69.windowManager.buildFromXML(_loc8_.content as XML) as ITextWindow;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         if(this.var_69 != null && this.var_69.issueManager != null && this.var_166 != null)
         {
            this.var_69.issueManager.removeHandler(this.var_166.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_69.issueManager.closeBundle(this.var_166.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_69.issueManager.closeBundle(this.var_166.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_69.issueManager.closeBundle(this.var_166.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_69.issueManager.releaseBundle(this.var_166.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_69.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_69,WindowTracker.const_1196,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_536 = new UserInfoCtrl(this._window,this.var_69,_loc3_.message);
            this.var_536.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      {
         if(this._window == null || this.var_69 == null || this.var_69.issueManager == null)
         {
            return;
         }
         ...
         {
            this.var_69.issueManager.autoPick();
         }
      }
   }
}
