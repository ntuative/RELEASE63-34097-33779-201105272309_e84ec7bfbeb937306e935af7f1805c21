package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1237:String = "issue_bundle_open";
      
      public static const const_966:String = "issue_bundle_my";
      
      public static const const_1277:String = "issue_bundle_picked";
      
      public static const const_1752:int = 15000;
       
      
      private var var_69:ModerationManager;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_646 = new IssueBrowser(this,this.var_69.windowManager,this.var_69.assets);
         this.var_1218 = [];
         this.var_1219 = [];
         this.var_981 = new Map();
         this.var_2594 = parseInt(this.var_69.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1867 = new Timer(const_1752,0);
         this.var_1867.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1867.start();
      }
      ...
      {
         var _loc4_:IssueBundle = this.var_110.getValue(param1) as IssueBundle;
         if(_loc4_ == null)
         {
            return;
         }
         this.sendPick(_loc4_.getIssueIds(),param2,param3);
         this.var_1218 = this.var_1218.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = this.var_110.getValues();
      ...
      public function releaseAll() : void
      {
         ...
         var _loc1_:int = this.var_69.sessionDataManager.userId;
         var _loc2_:* = [];
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         var _loc2_:IssueBundle = this.var_110.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(param1 == null || param1.length == 0 || this.var_69 == null || this.var_69.connection == null)
         {
            return;
         }
         this.var_69.connection.send(new ReleaseIssuesMessageComposer(param1));
         this.var_1219 = this.var_1219.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_69.soundManager.playSound(HabboSoundTypesEnum.const_1265);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_980.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_110.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     this.var_110.remove(_loc3_.id);
                     this.removeHandler(_loc3_.id);
                  }
                  this.var_980.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1719)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_110)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_980.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2595++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_980.add(param1.issueId,_loc2_);
            this.var_110.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(this.var_1218.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_69.sessionDataManager.userId;
         ...
         {
            _loc6_ = this.getBundles(const_966);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1219.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_69 == null || this.var_69.configuration == null)
         {
            return;
         }
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2594);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_981.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_981.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_980.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_110.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         var _loc2_:* = [];
         var _loc3_:int = this.var_69.sessionDataManager.userId;
         for each(_loc4_ in this.var_110)
         {
            switch(param1)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = new IssueHandler(this.var_69,_loc2_);
         this.removeHandler(param1);
         this.var_981.add(param1,_loc3_);
         this.var_69.windowTracker.show(_loc3_,null,false,false,false);
         this.var_1218 = [];
      }
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_981.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc3_:IssueBundle = this.var_110.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         if(param1 == null || this.var_69 == null || this.var_69.connection == null)
         {
            return;
         }
         this.var_69.connection.send(new CloseIssuesMessageComposer(param1,param2));
      }
      ...
      private function sendPick(param1:Array, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_69.connection.send(new PickIssuesMessageComposer(param1,param2,param3));
      }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = this.var_110.getValues();
         var _loc4_:int = this.var_69.sessionDataManager.userId;
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc8_ = null;
            for each(_loc9_ in this.var_110)
            {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_981.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
