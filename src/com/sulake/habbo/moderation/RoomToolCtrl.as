package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         return WindowTracker.const_1871;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1467 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function method_6(param1:IItemListWindow, param2:IWindow) : void
      {
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(!param1.exists)
         {
            this.method_6(this.var_61,_loc3_);
            this.method_6(this.var_61,this.var_61.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_913,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1701,_loc2_,this.var_492.text,"",""));
         if(this.var_1468.isSelected || this.var_1467.isSelected || this.var_957.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1468.isSelected,this.var_1467.isSelected,this.var_957.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1711);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1677);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1175.selection];
         if(_loc3_ != null)
         {
            this.var_671 = false;
