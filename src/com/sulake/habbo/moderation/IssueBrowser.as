package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2257:String = "my_issues";
      
      private const const_2255:String = "open_issues";
      
      private const const_2256:String = "picked_issues";
      
      private const const_2269:String = "closed_issues";
      ...
      private var var_1931:IIssueBrowserView;
      
      private var var_1932:IIssueBrowserView;
      
      private var var_1933:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_368.view.width = this.var_268.container.width;
         this.var_368.view.height = this.var_268.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2257:
               if(this.var_1931 == null)
               {
                  this.var_1931 = new MyIssuesView(this.issueManager,this,this.var_268.container);
               }
               return this.var_1931;
            case this.const_2255:
               if(this.var_1932 == null)
               {
                  this.var_1932 = new OpenIssuesView(this.issueManager,this,this.var_268.container);
               }
               return this.var_1932;
            case this.const_2256:
               if(this.var_1933 == null)
               {
                  this.var_1933 = new PickedIssuesView(this.issueManager,this,this.var_268.container);
               }
