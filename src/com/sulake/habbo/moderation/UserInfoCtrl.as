package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1042:int = 3600;
      
      private static const const_1039:int = 86400;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_1039)
         {
            return Math.round(param1 / const_1042) + " hours ago";
         }
         if(param1 < 2 * const_1041)
         {
            return Math.round(param1 / const_1039) + " days ago";
         }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1191.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1191.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1172,this._data.userId),this._callerFrame,this.var_1192,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1192,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1390),this._callerFrame,this.var_1192,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1390),this._callerFrame,this.var_1192,false,true);
      }
