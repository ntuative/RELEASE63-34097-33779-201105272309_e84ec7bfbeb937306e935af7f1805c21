package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_856:IssueMessageData = null;
      
      private var var_857:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2231 = param2.pickerUserId;
         this.var_2908 = param2.pickerUserName;
         this.var_1634 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_856 == null || param1.timeStamp < this.var_856.timeStamp)
         {
            this.var_856 = param1;
         }
         if(this.var_857 == null || param1.priority > this.var_857.timeStamp)
         {
            this.var_857 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(this.var_856 == _loc2_)
            {
               this.var_856 = null;
            }
            if(this.var_857 == _loc2_)
            {
               this.var_857 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_857;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_856;
         if(_loc2_ == null)
         {
