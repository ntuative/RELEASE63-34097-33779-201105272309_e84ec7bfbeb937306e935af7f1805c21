package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1056:uint = 11;
      ...
      private var var_440:FramerateTracker = null;
      
      private var var_260:LatencyTracker = null;
      
      private var var_638:LagWarningLogger = null;
      
      private var var_441:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_440 = new FramerateTracker();
         this.var_260 = new LatencyTracker();
         this.var_638 = new LagWarningLogger();
         this.var_441 = new ToolbarClickTracker(this);
         this.var_1495 = new Array(const_1056);
         var _loc4_:int = 0;
         while(_loc4_ < const_1056)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1648,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1834,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1840,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_823,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1232,String(0));
         }
         ...
         if(!disposed)
         {
            ...
            if(this.var_211)
            {
               if(!this.var_211.disposed)
               {
                  ...
                  Component(this.var_211).events.removeEventListener(HabboFriendListTrackingEvent.const_626,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_306,this.onRoomAction);
            ...
            {
               this.var_305.stop();
               this.var_305.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_305 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_182)
         {
            if(this.var_260 != null)
            {
               this.var_260.configuration = this.var_182;
            }
            if(this.var_261 != null)
            {
               this.var_261.configuration = this.var_182;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1844);
            if(this.var_182)
            {
               if(this.var_638 != null)
               {
                  this.var_638.configure(this.var_182);
               }
               if(this.var_440 != null)
               {
                  this.var_440.configure(this.var_182);
               }
               if(this.var_441 != null)
               {
                  this.var_441.configure(this.var_182);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_770,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_919,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_68,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_473,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_638 != null)
            {
               this.var_638.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_919)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1854);
         }
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1937);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_770:
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1294);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1294,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_211).events.addEventListener(HabboFriendListTrackingEvent.const_626,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_626:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2569)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1724);
            this.var_2569 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1232,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_823,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_306,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_332.events.addEventListener(AdEvent.const_570,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_306)
         {
            if(this.var_1843 < 1)
            {
               if(!this.var_305)
               {
                  this.var_305 = new Timer(60000,1);
                  this.var_305.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_305.start();
               }
            }
         }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_440)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_440.frameRate),_loc2_);
                  ++this.var_1843;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_441)
         {
            this.var_441.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_441)
         {
            this.var_441.track(param1.type);
         }
      }
      ...
      {
         this.var_638.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1844;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1844);
         }
         if(this.var_527 > -1 && _loc2_ - this.var_527 > 15000)
         {
            ++this.var_1842;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1842);
         }
         this.var_527 = _loc2_;
         if(this.var_261 != null)
         {
            this.var_261.update(param1,this.var_527);
         }
         if(this.var_260 != null)
         {
            this.var_260.update(param1,this.var_527);
         }
         if(this.var_440 != null)
         {
            this.var_440.trackUpdate(param1,this,this.var_527);
         }
         if(this.var_638 != null)
         {
            this.var_638.update(this.var_527);
         }
      }
   }
}
