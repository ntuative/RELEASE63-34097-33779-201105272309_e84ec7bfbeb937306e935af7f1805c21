package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1858 = int(this.var_182.getKey("latencytest.interval"));
         this.var_1856 = int(this.var_182.getKey("latencytest.report.index"));
         this.var_2578 = int(this.var_182.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1857 > this.var_1858)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_644.add(this.var_1500,this.var_1857);
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         if(this.var_229.length == this.var_1856 && this.var_1856 > 0)
         {
            ...
            if(Math.abs(_loc9_ - this.var_1855) > this.var_2578 || this.var_1855 == 0)
            {
