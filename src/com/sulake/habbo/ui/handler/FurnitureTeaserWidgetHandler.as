package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_957,RoomWidgetViralFurniMessage.const_955,RoomWidgetViralFurniMessage.const_179];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_957:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_599);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_955:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_525,RoomSessionViralFurniStatusEvent.const_620];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_525:
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_620:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_830);
               _loc3_.campaignID = _loc2_.campaignID;
               _loc3_.status = _loc2_.status;
               _loc3_.data = _loc2_.shareId;
               _loc3_.itemCategory = _loc2_.itemCategory;
