package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_239.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_172,this.onUserTags);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_172,this.onUserTags);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_693.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_693.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_239 != null)
         {
            this.var_239.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_469);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_847);
         _loc1_.push(RoomWidgetFurniActionMessage.const_923);
         _loc1_.push(RoomWidgetFurniActionMessage.const_928);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1176);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_911);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_980);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_869);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1900);
         _loc1_.push(RoomWidgetPetCommandMessage.const_504);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_852);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_499)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_430 || param1.type == RoomWidgetUserActionMessage.const_496 || param1.type == RoomWidgetUserActionMessage.const_475)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_469:
            ...
            case RoomWidgetUserActionMessage.const_533:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1270,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_475:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_847:
            ...
            case RoomWidgetFurniActionMessage.const_269:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_923:
            ...
            case RoomWidgetFurniActionMessage.const_928:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1176:
            ...
            case RoomWidgetUserActionMessage.const_430:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_911:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_980:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_869:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_346);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_404) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_404);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_751) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1285;
               }
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1322);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_551)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_399) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_399.length);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_203)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_605)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_546);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_142)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_848);
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1878);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_693.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_693.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_848);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_239 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_443,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
