package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1621:IMessageEvent;
      
      private var var_2106:IMessageEvent;
      
      private var var_2105:IMessageEvent;
      ...
      {
         this.var_1621 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2106 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2105 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1621);
         this._connection.addMessageEvent(this.var_2106);
         this._connection.addMessageEvent(this.var_2105);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1621);
               this._connection.removeMessageEvent(this.var_2106);
               this._connection.removeMessageEvent(this.var_2105);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_858,RoomWidgetPlayListModificationMessage.const_898,RoomWidgetPlayListModificationMessage.const_936,RoomWidgetPlayListPlayStateMessage.const_732,RoomWidgetPlayListUserActionMessage.const_989];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_858:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_807,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_898:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_936:
            ...
            case RoomWidgetPlayListPlayStateMessage.const_732:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_989:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_283);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_283:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_875,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_833,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_900));
               break;
