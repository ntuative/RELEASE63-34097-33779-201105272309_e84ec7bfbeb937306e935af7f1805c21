   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_331,this.onFigureUpdate);
            }
            if(this.var_13 && !this.var_13.disposed && this.var_13.events)
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_817,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_964,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_811,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_331,this.onFigureUpdate);
         }
         this.var_13 = this._container.inventory;
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_817,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_964,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_811,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1515)
            {
               ...
               this.var_1906 = _loc1_;
               this.var_1907 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1906;
               _loc2_ = this.var_1907;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_455)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_455,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_455 - const_1070)
                  {
                     _loc8_.offset(0,_loc2_.height - const_455 + const_1070);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_824);
         _loc1_.push(RoomWidgetDanceMessage.const_708);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_927);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_778);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_820);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_941);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_822);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_424);
         _loc1_.push(RoomWidgetStopEffectMessage.const_771);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1905);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1189);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_414);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1823);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1210);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_917);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_872);
         _loc1_.push(RoomWidgetMeMenuMessage.const_986);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_969);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_409);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_861);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_872:
               ...
               break;
            case RoomWidgetWaveMessage.const_824:
            ...
            case RoomWidgetDanceMessage.const_708:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_927:
               if(this.var_13 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_778:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_820:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_424:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1329)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_205,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_822:
               ...
               if(this.var_13 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1122:
                        this._catalog.openCatalogPage(CatalogPageName.const_1694,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1312:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_259);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1884:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_69);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1842:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_771:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1189:
               Logger.log("MeMenuWidgetHandler: GO HOME");
               if(this._container != null)
               {
                  this._container.navigator.method_14();
               }
               break;
            case RoomWidgetShowOwnRoomsMessage.const_917:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_986:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     _loc10_ = this._container.sessionDataManager.hasUserRight("fuse_use_club_dance",HabboClubLevelEnum.const_46);
                  }
            ...
            case RoomWidgetGetSettingsMessage.const_871:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_382,this._container.soundManager.volume));
               break;
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_128:
               ...
               break;
            case HabboHelpTutorialEvent.const_811:
