package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_721:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_294 != null)
         {
            ...
            {
               _loc2_ = this.var_294.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_714,RoomWidgetChatSelectAvatarMessage.const_901];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_714:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_46) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1334))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_46) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1334))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_901:
      ...
      {
         return [RoomSessionChatEvent.const_192];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_192:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_203)
                           {
                              _loc13_ = this.var_294.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_417.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_589.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_203:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_589.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_203)
                                    {
                                       this.var_294.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_721 == null)
            {
               ...
               this.var_494.y = 0;
               this.var_494.z = 0;
               this.var_721 = _loc4_.getScreenPoint(this.var_494);
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_721.x || _loc8_.y != this.var_721.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_721,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_294)
         {
            _loc2_ = this.var_294.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_589.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1672.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1672.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_294)
            {
               this.var_294.add(_loc3_,param2);
            }
         }
      }
   }
