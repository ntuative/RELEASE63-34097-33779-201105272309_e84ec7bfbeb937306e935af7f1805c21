package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_951,RoomWidgetEcotronBoxOpenMessage.const_876,RoomWidgetEcotronBoxOpenedMessage.const_1928];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_951:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_876:
