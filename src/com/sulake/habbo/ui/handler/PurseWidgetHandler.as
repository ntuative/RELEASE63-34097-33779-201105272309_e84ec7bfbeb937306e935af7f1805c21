package com.sulake.habbo.ui.handler
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_880);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_880:
            ...
            case RoomWidgetOpenCatalogMessage.const_424:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1159:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1699);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1173:
