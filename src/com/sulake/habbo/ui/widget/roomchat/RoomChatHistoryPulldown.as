package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1100:int = 3;
      ...
      private static const const_1015:int = 150;
      
      private static const const_1016:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_42 = param3;
         this.var_2371 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1735 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2368 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1736 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1734 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2370 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2366 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_77 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_319,HabboWindowStyle.const_30,HabboWindowParam.const_66,new Rectangle(0,0,param3.width,param3.height - const_87),null,0,0) as IBitmapWrapperWindow;
         this.var_42.addChild(this.var_77);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_83,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_42.height - const_87,param3.width,const_87),null,0) as IWindowContainer;
         this.var_42.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_527,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_87),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         switch(this.state)
         {
            case const_509:
               ...
               break;
            case const_1100:
               this.var_77.blend -= param1 / const_1015;
               this._window.blend -= param1 / const_1015;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_42.width - this.var_2369;
         }
         if(this.var_77 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2367 == this._window.width)
         {
            return;
         }
         this.var_2367 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2368;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1736;
            barX.disposesBitmap = false;
            this.var_2369 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2371,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1735,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1735,destGripRBitmap);
         ...
         this.var_77.bitmap = this.var_2366;
