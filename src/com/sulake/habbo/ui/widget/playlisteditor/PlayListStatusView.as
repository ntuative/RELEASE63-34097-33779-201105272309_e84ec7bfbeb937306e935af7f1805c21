package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_781:String = "PLSV_ADD_SONGS";
      
      public static const const_1180:String = "PLSV_START_PLAYBACK";
      
      public static const const_534:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_44 != const_534)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_455[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_455[const_781];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_455.add(const_534,_loc1_);
