package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_652:IItemGridWindow;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_652.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_106.playButtonState = MusicInventoryGridItem.const_1251;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_106 != null)
         {
            this.var_106.playButtonState = MusicInventoryGridItem.const_510;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_140;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_106.playButtonState == MusicInventoryGridItem.const_510)
               {
                  this.var_106.playButtonState = MusicInventoryGridItem.const_1175;
            ...
            {
               _loc4_ = this.var_652.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
