   ...
   public class DoorbellView
   {
      ...
      public function update() : void
      {
         ...
         if(this.var_61 != null)
         {
            ...
            {
               this.var_61.addListItem(this.createListItem(this.var_312.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      public function createMainWindow() : void
      {
         ...
         this._frame = this.var_312.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._frame == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
