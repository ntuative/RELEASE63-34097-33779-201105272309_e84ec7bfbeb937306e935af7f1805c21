package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1596:int = 152;
      
      private static const const_1588:int = 16;
      
      private static const const_677:int = 4;
      
      private static const const_1591:uint = 14342874;
      
      private static const const_1586:uint = 3815994;
      
      private static const const_1593:uint = 2085362;
      
      private static const const_1594:uint = 39616;
      
      private static const const_1597:uint = 10513106;
      
      private static const const_1598:uint = 8734654;
      
      private static const const_1590:uint = 9094430;
      
      private static const const_1599:uint = 6200576;
      
      private static const const_1589:String = "happiness";
      
      private static const const_1595:String = "experience";
      
      private static const const_1587:String = "energy";
      
      private static const const_1592:int = 250;
      
      private static const const_1099:int = 25;
      ...
      private var var_217:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1589,param1.nutrition,param1.nutritionMax,const_1594,const_1593);
         this.updateStateElement(const_1595,param1.experience,param1.experienceMax,const_1598,const_1597);
         this.updateStateElement(const_1587,param1.energy,param1.energyMax,const_1599,const_1590);
         ...
         if(this.var_217 && this.var_217.isVisible() && param1.isOwnPet)
         {
            this.var_217.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_217.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1596,const_1588,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1591);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1586);
      ...
      private function openTrainView() : void
      {
         if(this.var_217 == null)
         {
            this.var_217 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_505) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_217.showWindow(true);
            this.var_217.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_217 && this.var_217.getPetId() == this.var_505)
               {
                  this.var_217.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1099 + const_1098;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1098;
            }
         }
         this.var_101.height = _loc4_ + const_1099;
         this.updateWindow();
      }
   }
}
