package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2233:int = 5;
      
      private const const_2234:int = 5;
      ...
      private var var_1172:Rectangle = null;
      ...
      public function method_16(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         var _loc4_:* = null;
         var _loc8_:* = null;
         var _loc9_:* = null;
         ...
         this._offsetX = 0;
         this.var_1171 = 0;
         this.var_1172 = param2.rectangle.clone();
         this.var_1172.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1172.width)
         {
            return false;
         }
         if(this.var_1171 + param1.height > this.var_1172.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1172.width)
         {
            this._offsetX = 0;
            this.var_1171 += param1.height + this.const_2234;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1171);
         this._offsetX += param1.width + this.const_2233;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1461 != null && this.var_1461.indexOf(param1) != -1)
         {
