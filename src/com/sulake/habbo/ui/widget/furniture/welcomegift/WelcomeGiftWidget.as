package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_656:String = "welcome_gift_email_unverified";
      
      private const const_1035:String = "welcome_gift_email_verified";
      
      private const const_1481:String = "welcome_gift_email_change";
      
      private const const_2236:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         {
            this.setViewState(this.const_656);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_656:
               ...
               this._view.findChildByName("edit_text").visible = this.var_963;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_963);
               break;
            ...
            case this.const_1481:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_963);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1474;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1481);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_829,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1179 ? this.const_1035 : this.const_656);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1475 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1475));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_899,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_899,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_624:
               this.var_1474 = param1.email;
               this.var_1179 = param1.isVerified;
               this.var_963 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1474 = this.var_1475;
            this.setViewState(this.const_656);
         }
         else
         {
            if(param1.result == this.const_2236)
            {
               this.var_963 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1475);
