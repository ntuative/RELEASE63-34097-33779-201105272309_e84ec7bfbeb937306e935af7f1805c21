package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1479:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_624:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_83,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1419,const_1418,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_624 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1480 = _loc2_.light;
         if(this.var_436 != null)
         {
            this.var_436.setValue(this.var_1480);
         }
         this.var_529 = this.colors.indexOf(_loc2_.color);
         if(this.var_624 != null)
         {
            this.var_624.setSelectedColorIndex(this.var_529);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1479 = XML(_loc1_.content);
         return this.var_1479;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_624 != null)
         {
            this.var_624.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
