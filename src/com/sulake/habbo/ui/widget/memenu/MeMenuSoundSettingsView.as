package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_934:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_933 = param1.volume;
         if(this.var_934 != null)
         {
            this.var_934.setValue(this.var_933);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_932 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_936 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_935 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_931 = (_loc5_.content as BitmapData).clone();
         }
         this.var_934 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_933 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_931);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_932);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_935);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_936);
         }
      }
