package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuEffectsView implements IMeMenuView
   {
      ...
      public static const const_1267:Number = 55;
      ...
      public function updateEffects(param1:Array) : Boolean
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            _loc6_.window.y = _loc2_ * const_1267;
            _loc2_++;
         }
         _loc4_ = this._effectsContainer.height;
         _loc5_ = this.var_1003.length * const_1267;
      ...
      public function selectEffect(param1:EffectView) : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_820,param1.effect.type));
         }
         else
         {
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_1003)
         {
            _loc1_.dispose();
            _loc1_ = null;
         }
