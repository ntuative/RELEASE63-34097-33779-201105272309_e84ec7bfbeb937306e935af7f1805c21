package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2261:int = 1000;
      ...
      private var var_1022:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_216 = new Timer(this.const_2261);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_191.isActive)
         {
            ...
            this.var_1021.width = _loc2_ * this.var_326;
         }
         else
         {
            this.var_1021.width = 0;
            this.var_216.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_818 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_818 == null)
            {
               return;
            }
         ...
         if(!this.var_191.isActive)
         {
            this.var_818.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_818.caption = "${widgets.memenu.effects.active.timeleft}";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_1022 = this._window.findChildByName("effect_hilite");
            this.var_1022.visible = false;
         }
         this.setTimeLeft();
         this.var_1021 = this._window.findChildByName("loader_bar");
         if(this.var_1021 != null)
         {
            this.var_326 = this.var_1021.width;
            this.var_216.start();
            this.onUpdate();
         }
