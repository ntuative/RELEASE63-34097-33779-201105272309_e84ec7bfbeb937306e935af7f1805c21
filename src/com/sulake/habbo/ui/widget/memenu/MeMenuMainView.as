package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_159["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_159["dance_icon"] = ["dance_white","dance_color"];
         this.var_159["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_159["effects_icon"] = ["effects_white","effects_color"];
         this.var_159["badges_icon"] = ["badges_white","badges_color"];
         this.var_159["wave_icon"] = ["wave_white","wave_color"];
         this.var_159["hc_icon"] = ["_white","_color"];
         this.var_159["settings_icon"] = ["settings_white","settings_color"];
         this.var_159["credits_icon"] = ["credits_white","credits_color"];
         this.var_159["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_159[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_159[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_159[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_159)
         {
            _loc6_ = this.var_159[_loc3_];
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               switch(_loc3_)
               {
                  ...
                  case "hc_icon":
                     ...
                     {
                        if(this._widget.habboClubLevel == HabboClubLevelEnum.const_48)
                        {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1321);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1118));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1312));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_337);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1329));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_971);
               break;
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","HeightMapMessageEvent") == "true";
               if(false && _loc4_)
               {
