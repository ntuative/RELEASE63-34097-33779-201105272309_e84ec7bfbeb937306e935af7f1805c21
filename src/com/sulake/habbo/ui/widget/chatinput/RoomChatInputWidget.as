package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private var var_308:Timer = null;
      ...
      {
         return getTimer() - this.var_2576 > const_1518;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2576 = getTimer();
      }
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_714,param1,param2,param3);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1270:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1893:
         }
      }
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this._visualization.updateBlockText(this.var_308.repeatCount - this.var_308.currentCount);
         }
      }
      ...
      public function onFloodControl(param1:RoomWidgetFloodControlEvent) : void
      {
         ...
         {
            this.var_308 = new Timer(1000,param1.seconds);
            this.var_308.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_308.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_308.start();
         if(this._visualization != null)
         {
