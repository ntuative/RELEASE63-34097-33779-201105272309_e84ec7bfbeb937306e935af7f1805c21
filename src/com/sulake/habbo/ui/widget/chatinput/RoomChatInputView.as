package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1584:int = 250;
      
      private static const const_1585:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1583:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         ...
         this.var_2803 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2802 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this.var_1987 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1988 = this._window.findChildByName("send_button_text");
         this.var_1567 = this._window.findChildByName("block_text");
         this.var_1988.caption = const_1583;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_210,this.windowKeyEventProcessor);
         this.var_26.addEventListener(WindowKeyboardEvent.const_317,this.keyUpHandler);
         this.var_26.addEventListener(WindowEvent.const_106,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1568 = true;
         this.var_676 = "";
         this._window.addEventListener(WindowEvent.const_767,this.method_8);
         this._window.addEventListener(WindowEvent.const_486,this.method_8);
      }
      
      private function method_8(param1:WindowEvent = null) : void
      {
         var _loc2_:Point = new Point();
         this._window.getGlobalPosition(_loc2_);
         var _loc3_:int = _loc2_.x - this._window.x;
         var _loc4_:int = (this._window.desktop.width - this.var_1987.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1584 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1585);
      }
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_120);
