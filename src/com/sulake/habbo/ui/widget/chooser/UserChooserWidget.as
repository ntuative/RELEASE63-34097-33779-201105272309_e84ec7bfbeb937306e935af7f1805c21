package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private const const_1974:int = 1;
      
      private var var_449:ChooserView;
      ...
      {
         if(this.var_449 != null && this.var_449.isOpen())
         {
            return this.const_1974;
         }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_749,this.onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_182,this.onUpdateUserChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_828,this.onUpdateUserChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_749,this.onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_182,this.onUpdateUserChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_828,this.onUpdateUserChooser);
      }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(this.var_449 == null)
         {
            this.var_449 = new ChooserView(this,"${widget.chooser.user.title}");
         }
         this.var_449.populate(param1.items,false);
      }
