package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1255 = this.var_1954.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1255)
         {
            this.var_1255.procedure = this.onButtonClick;
         }
         this.var_1256 = this.var_1954.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1256)
         {
      ...
      {
         if(this.var_269 >= this.var_66.length - 1)
         {
      ...
      {
         ++this.var_269;
         this.var_269 = Math.min(this.var_269,this.var_66.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_66[this.var_269][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_66[this.var_269][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_66[this.var_269][1]).value;
