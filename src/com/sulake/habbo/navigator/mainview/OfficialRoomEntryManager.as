package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1403:int = 267;
      
      private static const const_1404:int = 65;
      
      private static const const_1405:int = -70;
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1712)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_915 || param2.type == OfficialRoomEntryData.const_803))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1404) : int(const_1403);
      ...
      private function refreshPublicSpaceImage(param1:IWindowContainer, param2:OfficialRoomEntryData, param3:IBitmapWrapperWindow) : void
      {
         ...
         param3.x = !!param2.showDetails ? int(const_1405) : 0;
      ...
      {
         var _loc4_:String = "guestRoom." + param2.method_1.thumbnail.getAsString();
         ...
         this._navigator.thumbRenderer.refreshBitmapContent(param3.bitmap,param2.method_1.thumbnail);
         param3.tags.splice(0,param3.tags.length);
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         Logger.log("ENTRY CLICKED: " + _loc2_.picText + ", " + _loc2_.method_1 + ", " + _loc2_.publicRoomData + ", " + _loc2_.tag);
         if(_loc2_.method_1 != null)
         {
            Logger.log("ENTERING ROOM: " + _loc2_.method_1.flatId);
            if(_loc2_.method_1.doorMode == RoomSettingsFlatInfo.const_134)
            {
               this._navigator.passwordInput.show(_loc2_.method_1);
            }
            else
            {
               this._navigator.goToRoom(_loc2_.method_1.flatId,true);
            }
         }
         else if(_loc2_.tag != null)
         {
            Logger.log("MAKING TAG SEARCH: " + _loc2_.tag);
            this._navigator.mainViewCtrl.startSearch(Tabs.const_191,Tabs.const_441,_loc2_.tag);
         }
      ...
      public function getPopupCaption(param1:OfficialRoomEntryData) : String
      {
         ...
         if(param1.method_1 != null)
         {
            return param1.method_1.roomName;
         }
      ...
      public function getPopupDesc(param1:OfficialRoomEntryData) : String
      {
         ...
         if(param1.method_1 != null)
         {
            return param1.method_1.description;
         }
         if(param1.publicRoomData != null)
         {
