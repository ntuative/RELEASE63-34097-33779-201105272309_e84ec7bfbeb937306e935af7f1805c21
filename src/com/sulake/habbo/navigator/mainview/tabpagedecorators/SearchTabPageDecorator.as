package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1891:TextSearchInputs;
      ...
      {
         var _loc4_:* = null;
         if(this.var_1891 == null)
         {
            _loc4_ = param1.getChildByName("search_header") as IWindowContainer;
            this.var_1891 = new TextSearchInputs(this._navigator,false,_loc4_);
            this.initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(this._navigator.data.guestRoomSearchArrived && this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_295)
         {
            this.var_1891.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_441)
            {
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_191,Tabs.const_295,"-1",MainViewCtrl.const_832);
      }
