package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_298:MainViewCtrl;
      
      private var var_597:RoomInfoViewCtrl;
      
      private var var_1144:RoomCreateViewCtrl;
      ...
      private var var_2330:RoomThumbnailRenderer;
      
      private var var_1043:GuestRoomPasswordInput;
      
      private var var_312:GuestRoomDoorbell;
      
      private var var_1145:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2329 = new Array();
         ...
         this.var_298 = new MainViewCtrl(this);
         this.var_597 = new RoomInfoViewCtrl(this);
         this.var_1144 = new RoomCreateViewCtrl(this);
         this.var_2330 = new RoomThumbnailRenderer(this);
         this.var_1043 = new GuestRoomPasswordInput(this);
         this.var_312 = new GuestRoomDoorbell(this);
         this.var_437 = new Tabs(this);
         this.var_1145 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_319,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_298.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_298.startSearch(Tabs.const_191,Tabs.const_441,param1);
         this.var_298.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_298.startSearch(Tabs.const_260,Tabs.const_276);
         this.var_437.getTab(Tabs.const_260).tabPageDecorator.tabSelected();
      }
