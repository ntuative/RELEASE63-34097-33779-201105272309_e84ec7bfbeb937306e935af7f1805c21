package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1429:int = 5;
      
      private static const const_1425:int = 6;
      
      private static const const_1421:int = 3;
      
      private static const const_1428:int = 2;
      
      private static const const_1014:int = 6;
      
      private static const const_1426:int = 180;
      
      private static const const_1431:int = 246;
      
      private static const const_1430:int = 45;
      
      private static const const_1427:Point = new Point(115,93);
      
      private static const const_1424:Point = new Point(72,1);
      ...
      private var var_598:ProgressBar;
      
      private var var_741:ProgressBar;
      
      private var var_1149:Matrix;
      
      private var var_1727:ColorMatrixFilter;
      
      private var var_1425:AchievementData;
      
      private var var_742:Timer;
      
      private var var_599:Dictionary;
      
      private var var_738:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_433 = new Timer(100,1);
         this.var_433.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_742 = new Timer(2000,1);
         this.var_742.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_738 = new AchievementLevelUp(this._questEngine);
         this.var_1149 = new Matrix();
         this.var_1727 = this.createGrayscaleFilter();
         this.var_599[16] = 1;
         this.var_599[28] = 6;
         this.var_599[38] = 4;
         this.var_599[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_433)
         {
            this.var_433.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_433.reset();
            this.var_433 = null;
         }
         if(this.var_742)
         {
            this.var_742.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_742.reset();
            this.var_742 = null;
         }
         if(this.var_598)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1430;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_422.height = getLowestPoint(this.var_422);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         ...
         this.var_741.refresh(this.var_107.getProgress(),this.var_107.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_740.height = getLowestPoint(this.var_740);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_941.findChildByName("category_name_txt").caption = this._questEngine.getAchievementCategoryName(this._category.code);
         ...
         this._questEngine.setupAchievementCategoryImage(this.var_941,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         if(this.var_68 == null)
         {
            this.var_423.visible = false;
            return;
         }
         this.var_423.visible = true;
         var _loc1_:String = this.getAchievedBadgeId(this.var_68);
         this.var_423.findChildByName("achievement_name_txt").caption = this._questEngine.localization.getBadgeName(_loc1_);
         var _loc2_:String = this._questEngine.localization.getBadgeDesc(_loc1_);
         this.var_423.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         ...
         this._questEngine.refreshReward(!this.var_68.finalLevel,this.var_423,this.var_68.levelRewardPointType,this.var_68.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_423,this.var_68);
         this.var_598.refresh(this.var_68.currentPoints,this.var_68.scoreLimit,this.var_68.type * 10000 + this.var_68.level);
         this.var_598.visible = !this.var_68.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this._window.y = const_1423;
         this.var_422 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_941 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_740 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_423 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1424 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1150 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_598 = new ProgressBar(this._questEngine,this.var_423,const_1426,"achievements.details.progress",true,const_1427);
         this.var_741 = new ProgressBar(this._questEngine,this.var_1150,const_1431,"achievements.categories.totalprogress",true,const_1424);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_422.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_648);
         var _loc5_:* = _loc4_ < const_1421;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1432) * (param1 % const_648);
            _loc3_.y = (_loc3_.height + const_1429) * Math.floor(param1 / const_648) + const_1425;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_740.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1014);
         var _loc5_:* = _loc4_ < const_1428;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.x = _loc3_.width * (param1 % const_1014);
            _loc3_.y = _loc3_.height * _loc4_ + const_1433;
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_422.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_422.getChildAt(_loc2_));
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_739[_loc4_];
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_739[_loc4_] = _loc5_;
         }
         var _loc7_:int = const_1013 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1422) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_1727);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1013 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1149.identity();
         this.var_1149.scale(2,2);
         this.var_1149.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1149);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_1727);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_68 = this.var_1425;
         this.var_107.update(this.var_1425);
         this.var_1425 = null;
         this.refresh();
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_739[param1.badgeId] = param1.badgeImage;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_598.updateView();
         }
         if(this.var_741 != null)
         {
            this.var_741.updateView();
         }
         if(this.var_738 != null)
         {
            this.var_738.update(param1);
         }
      }
      ...
      {
         return !!this.var_599[param1] ? int(this.var_599[param1]) : 0;
      }
