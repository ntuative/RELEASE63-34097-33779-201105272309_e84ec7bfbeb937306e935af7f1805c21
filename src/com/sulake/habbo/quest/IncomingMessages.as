package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_2044:IAlertDialog;
      ...
      {
         return this._questEngine.configuration.getKey("standaloneAchievementList.enabled","HeightMapMessageEvent") == "true";
      }
   }
}
