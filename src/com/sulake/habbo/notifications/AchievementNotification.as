package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1991:String = "badge_bg_001_png";
      
      private const const_2260:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1651 = param4;
         this.var_1545 = param7;
         ...
         this._window.center();
         this.var_2760 = this.var_66.getBadgeName(this.var_318);
         this.var_2763 = this.var_66.getBadgeDesc(this.var_318);
         this.var_2759 = this.var_66.getAchievementNameForFacebook(this.var_318,this.var_366.userName,this.var_366.realName,this.var_1138);
         this.var_2761 = this.var_66.getAchievementDescForFacebook(this.var_318,this.var_366.userName,this.var_366.realName,this.var_1138);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2758 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_66.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1651.toString());
         this.var_66.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1545.toString());
         this.var_66.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1545.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1966;
         var _loc17_:String = this.var_1966 == 0 ? "pixels" : "activitypoints";
         this.var_66.registerParameter(_loc16_,_loc17_,"" + this.var_2657);
         _loc15_.caption = this.var_66.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1991);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2260) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1545 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_318,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_318,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_318,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_66.registerParameter(param1,"badge_name",this.var_2760);
         this.var_66.registerParameter(param1,"badge_desc",this.var_2763);
         this.var_66.registerParameter(param1,"badge_name_fb",this.var_2759);
         this.var_66.registerParameter(param1,"badge_desc_fb",this.var_2761);
         this.var_66.registerParameter(param1,"level",this.var_1138.toString());
         this.var_66.registerParameter(param1,"name",this.var_366.userName);
         return this.var_66.registerParameter(param1,"realname",this.var_366.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_366.events.removeEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImageReady);
            this.var_366 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_318)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1991);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_318,this._feedTitleFb,this.var_2758,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2762));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_318,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_318,"client.skip_post"));
               this.dispose();
               return;
         }
      }
