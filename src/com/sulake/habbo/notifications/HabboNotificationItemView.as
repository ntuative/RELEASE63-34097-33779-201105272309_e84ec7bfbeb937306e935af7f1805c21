package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_470:int = 70;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2000 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2000 = 15;
         }
         this.var_1999 = this._window.height;
         this.var_1572 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_509:
               ...
               _loc2_ = Number(this.var_1287) / Number(this.var_1039["time_fade_in"]);
               if(this.var_1287 > int(this.var_1039["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1101:
               ...
               if(this.var_1573 > int(this.var_1039["time_display"]) && !this.var_2001)
               {
                  this.startFadeOut();
               }
               break;
            case const_1100:
               ...
               _loc3_ = 1 - Number(this.var_1286) / Number(this.var_1039["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1286 > int(this.var_1039["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(this._window.height < this.var_1999)
         {
            this._window.height = this.var_1999;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1747;
         this._window.y = this.var_1572;
      }
