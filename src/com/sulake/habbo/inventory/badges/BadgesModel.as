package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_1668:int = -1;
      ...
      private const const_2259:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_366 = param5;
         this.var_366.events.addEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImageReady);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1262.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_665.indexOf(param3) != -1;
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_334);
         var _loc3_:int = 0;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_607);
         ...
         var _loc3_:Array = this.getBadges(const_334);
      ...
      {
         return this.getItemInIndex(param1,const_334);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_607);
      }
      ...
      {
         if(param1 == InventoryCategory.const_259 && this._controller.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_665.indexOf(_loc2_) == -1)
            {
               this.var_665.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_665 && this.var_665.length > 0)
         {
