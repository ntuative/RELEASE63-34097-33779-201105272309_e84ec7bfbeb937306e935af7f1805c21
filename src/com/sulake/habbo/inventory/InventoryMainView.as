package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_1708:IWindowContainer;
      
      private const const_1959:Point = new Point(120,150);
      ...
      {
         return !!this.var_17 ? Boolean(this.var_17.getStateFlag(WindowState.const_85)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_730);
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_730);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_69:
               ...
               break;
            case InventoryCategory.const_119:
               this._controller.petsModel.resetUnseenItems();
               break;
            case InventoryCategory.const_259:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1707);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_346 == InventoryCategory.const_119)
            {
               this.toggleCategoryView(InventoryCategory.const_119);
            }
            else if(this.var_346 == InventoryCategory.const_69)
            {
               this.toggleCategoryView(InventoryCategory.const_69);
            }
            else if(this._controller != null)
            {
               this._controller.toggleInventoryPage(InventoryCategory.const_69);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1708)
         {
            this.var_1708 = this.createCounter("badges");
         }
         var _loc1_:int = this._controller.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1708,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_1008;
            _loc3_.y = const_1008;
         }
         return _loc3_;
      }
