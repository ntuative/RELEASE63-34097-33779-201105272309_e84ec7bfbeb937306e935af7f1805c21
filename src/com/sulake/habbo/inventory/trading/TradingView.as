package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1097:uint = 2577770;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(this.var_73 == null)
         {
            this.var_73 = this.createNormalWindow();
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_73)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1096) : uint(const_1097);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1096) : uint(const_1097);
            }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1936)
            {
            ...
            this.var_677.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_550);
            this.var_677.show();
         }
         ...
         if(this.var_194.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_677.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_550);
               }
            }
            else
            {
