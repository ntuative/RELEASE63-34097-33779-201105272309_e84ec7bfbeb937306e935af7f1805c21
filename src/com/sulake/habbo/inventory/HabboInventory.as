package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2265:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_54)
         {
            _loc1_ = this.var_54.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_54.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_511,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_54.getValue(InventoryCategory.const_69));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_54.getValue(InventorySubCategory.const_343));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_54.getValue(InventoryCategory.const_961));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_54.getValue(InventoryCategory.const_259));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_54.getValue(InventoryCategory.ACHIEVEMENTS));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_54.getValue(InventorySubCategory.const_1293));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_54.getValue(InventoryCategory.const_119));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_54.getValue(InventoryCategory.const_381) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_511,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               this.var_1200 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_511:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      private function initInventory() : void
      {
         ...
         this.var_54.add(InventoryCategory.const_381,_loc1_);
         ...
         this.var_54.add(InventoryCategory.const_961,_loc4_);
         ...
         this.var_54.add(InventoryCategory.ACHIEVEMENTS,_loc5_);
         ...
         this.var_54.add(InventorySubCategory.const_343,_loc6_);
         ...
         this.var_54.add(InventorySubCategory.const_1293,_loc7_);
         ...
         this.var_54.add(InventoryCategory.const_119,_loc8_);
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_54.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_54.length)
         {
            _loc3_ = this.var_54.getWithIndex(_loc2_) as IInventoryModel;
      ...
      public function closingInventoryView() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_54.length)
         {
            _loc2_ = this.var_54.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1060.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1060.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1060.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1060.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:IInventoryModel = this.var_54.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2265);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_817));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2888)
         {
            this.var_2888 = _loc1_;
