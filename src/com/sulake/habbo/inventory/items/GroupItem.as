package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1526:int = 13421772;
      
      private static const const_1527:int = 10275685;
      ...
      protected var var_893:int = 0;
      
      protected var var_709:BitmapData;
      ...
      protected var var_2965:BitmapData;
      
      private var var_1542:Boolean;
      
      private const const_1990:Number = 1;
      
      private const const_1989:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2642 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2181 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1558));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2177);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_831)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1989;
               _loc1_.blend = this.const_1989;
            }
            else
            {
               this._window.blend = this.const_1990;
               _loc1_.blend = this.const_1990;
            }
         }
         this.var_1503.color = !!this.var_1542 ? uint(const_1527) : uint(const_1526);
         this.var_2642.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2180 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2965;
               _loc5_.visible = true;
            }
            else
            {
