   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_72.toggleItemSelection(this._category,this.var_218.getGridItemIndex(param1.window));
            this.var_553 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_553 != null && this.var_553 == param2 && !this.var_72.isTradingOpen)
         {
