package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1494:int = 100;
      
      private static const const_1495:int = 1000;
      ...
      private var var_1825:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_439 = [];
         this.var_438 = [];
         this.var_631 = new Timer(const_1494,1);
         this.var_631.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2542 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_631.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_631.stop();
               this.var_631 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_1825 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1825;
            }
            else
            {
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_69);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_310)
         {
         ...
         else if(param3 == FurniCategory.const_305)
         {
         ...
         if(this.var_775 == null)
         {
            this.var_775 = this._windowManager.buildFromXML(this.var_2542) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_775.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_775.clone() as IWindowContainer;
      ...
      {
         if(param1 == InventoryCategory.const_69 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_237:
                  this._controller.toggleInventoryPage(InventoryCategory.const_119);
            }
         }
      }
      ...
      {
         this.var_2541 = getTimer();
         this.switchCategory(const_237);
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_381);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_632.add(const_39,new Array());
         this.var_632.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_39;
            _loc5_ = this.var_439.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_438.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_237)
            {
      ...
      {
         return getTimer() < this.var_2541 + const_1495;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_343;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_309 || _loc3_.category == FurniCategory.const_310 || _loc3_.category == FurniCategory.const_305)
         {
            if(param1)
            {
               return false;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_343:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_632.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_831)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_439.indexOf(_loc2_) == -1)
            {
               this.var_439.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_438.indexOf(_loc2_) == -1)
            {
               this.var_438.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_444:
               return this.var_439.length;
            case UnseenItemCategoryEnum.const_437:
               return this.var_438.length;
            default:
               return this.var_439.length + this.var_438.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_45:
               if(this.var_438 && this.var_438.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_437));
                  this.var_438 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_39:
               if(this.var_439 && this.var_439.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_444));
                  this.var_439 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
