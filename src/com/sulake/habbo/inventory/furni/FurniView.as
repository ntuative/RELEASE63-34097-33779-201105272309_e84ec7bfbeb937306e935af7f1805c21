package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1992:int = 0;
      ...
      private static const const_1087:int = 42;
      
      private static const const_1086:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_377.add(FurniModelCategory.const_39,new FurniGridView(this.var_72,FurniModelCategory.const_39,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_377.add(FurniModelCategory.const_45,new FurniGridView(this.var_72,FurniModelCategory.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_377.getValue(this.var_462);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_72.getCategoryContent(this.var_462);
         ...
         if(this.var_2229 == _loc2_)
         {
            return;
         }
         this.var_2229 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_377.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_377.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_377.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_377.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_72.getUnseenItemCount(UnseenItemCategoryEnum.const_444) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_72.getUnseenItemCount(UnseenItemCategoryEnum.const_437) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_72.getGroupItemInIndex(_loc3_,this.var_462);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_218);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_200);
            ...
            if(_loc5_.category == FurniCategory.const_310)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_305)
            {
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1309)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1086)
         {
            _loc3_ = const_1086;
         }
         else if(_loc3_ < const_1087)
         {
            _loc3_ = const_1087;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_49)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_237);
            }
         }
      }
