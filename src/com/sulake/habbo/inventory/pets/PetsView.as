package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1992:int = 0;
      
      private const const_1026:int = 1;
      
      private const const_1088:int = 2;
         ...
         if(param1.type == WindowEvent.const_49)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_72.switchToFurnitureCategory(FurniModelCategory.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_72.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_444) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_72.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_437) > 0;
