package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1435:Point = new Point(3,3);
      
      private static const const_1570:uint = 7433577;
      
      private static const const_1571:uint = 5723213;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1435;
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_926:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_805:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_460 ? this.var_1552 : this.var_1551;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_460)
         {
            param1.color = const_1570;
         }
         else
         {
            param1.color = const_1571;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1551)
         {
            this.var_1551.dispose();
         }
         this.var_1551 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1552)
         {
            this.var_1552.dispose();
         }
         this.var_1552 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1024.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1008;
            _loc2_.y = const_1008;
            this.var_1024.add(param1,_loc2_);
         }
         return _loc2_;
      }
