package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1502:uint = 12247545;
      
      private static const const_1501:String = "HELP";
      
      private static const const_1499:String = "ROOMINFO";
      ...
      private const const_743:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_61 = this._window.findChildByName("list") as IItemListWindow;
         var _loc7_:* = [];
         this.var_61.groupListItemsWithTag("REGION",_loc7_);
      ...
      {
         this.var_61.removeListItem(this.var_394);
      }
      
      public function showRoomInfo() : void
      {
         this.var_61.addListItemAt(this.var_394,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_877;
         _loc3_.y = this.const_743;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_637)
         {
            this.var_637 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1501);
               break;
