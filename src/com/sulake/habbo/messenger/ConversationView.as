package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1080:int = 100;
      
      private static const const_1551:int = 20;
      ...
      private var var_1948:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_149 = param1;
         this.var_1948 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_61 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2713 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_149.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1080 + const_1551)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_149.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1552;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1948.enable();
         }
         else
         {
            this.var_1948.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_61.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_539.messages.length - const_1080);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_149.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_887 || param3.type == Message.const_991 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_149.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_149.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_149.send(new FollowFriendMessageComposer(this.var_539.id));
         this.var_149.send(new ConversionPointMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_149.conversations.closeConversation();
