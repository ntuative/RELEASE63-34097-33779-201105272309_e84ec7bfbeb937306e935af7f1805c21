package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1458:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_161:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2976 = new Array();
         this.var_161 = this.profiler;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_161)
         {
            this.var_161.removeStopEventListener(this.refresh);
            this.var_161 = null;
         }
         if(!this.var_161 && param1)
         {
            this.var_161 = param1;
            this.var_161.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_583)
            {
               this.var_1773 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_161.getProfilerAgentsInArray();
         ...
         if(this.var_1773)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_161.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_161.numBitmapAssetInstances + " / " + this.var_161.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_942.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_161.numTrackedBitmapDataInstances + " / " + this.var_161.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1458() as ByteArray;
