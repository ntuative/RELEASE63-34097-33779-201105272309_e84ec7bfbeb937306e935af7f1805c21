   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_335 = SkinLayoutEntity.const_584;
                  break;
               case "move":
                  _loc5_.var_335 = SkinLayoutEntity.const_316;
                  break;
               case "strech":
                  _loc5_.var_335 = SkinLayoutEntity.const_540;
                  break;
               case "tiled":
                  _loc5_.var_335 = SkinLayoutEntity.const_348;
                  break;
               case "center":
                  _loc5_.var_335 = SkinLayoutEntity.const_585;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_333 = SkinLayoutEntity.const_584;
                  break;
               case "move":
                  _loc5_.var_333 = SkinLayoutEntity.const_316;
                  break;
               case "strech":
                  _loc5_.var_333 = SkinLayoutEntity.const_540;
                  break;
               case "tiled":
                  _loc5_.var_333 = SkinLayoutEntity.const_348;
                  break;
               case "center":
                  _loc5_.var_333 = SkinLayoutEntity.const_585;
            }
         }
