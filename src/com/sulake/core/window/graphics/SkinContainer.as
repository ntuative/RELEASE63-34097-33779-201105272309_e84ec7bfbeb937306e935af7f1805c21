package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1007:uint = 8;
      
      private static const const_1399:String = "skin";
      
      private static const const_1398:String = "bitmap";
      
      private static const const_1401:String = "fill";
      
      private static const const_1402:String = "text";
      
      private static const const_1397:String = "label";
      
      private static const const_1400:String = "shape";
      ...
      private var var_2300:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1705,this.var_2301);
         this.var_2300 = new Dictionary();
         this.var_2302 = new Dictionary();
         StateCodeTable.fillTables(this.var_2300,this.var_2302);
         this.var_421 = new Dictionary();
         this.var_421[const_1399] = BitmapSkinRenderer;
         this.var_421[const_1398] = BitmapDataRenderer;
         this.var_421[const_1401] = FillSkinRenderer;
         this.var_421[const_1402] = TextSkinRenderer;
         this.var_421[const_1397] = LabelRenderer;
         this.var_421[const_1400] = ShapeSkinRenderer;
         this.var_421[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_421[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_340 == null)
         {
            var_340 = new Array();
            var_340.push(WindowState.const_73);
            var_340.push(WindowState.const_86);
            var_340.push(WindowState.const_92);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2945 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1705[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_925[param1] = new Array(const_1007);
         }
         this.var_925[param1][param2] = param3;
         if(this.var_926[param1] == null)
         {
            this.var_926[param1] = new Array(const_1007);
         }
         this.var_926[param1][param2] = param4;
      }
