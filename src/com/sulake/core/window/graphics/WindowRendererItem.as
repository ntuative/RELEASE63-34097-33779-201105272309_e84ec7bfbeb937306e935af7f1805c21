package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_671:uint = 0;
      
      private static const const_1090:uint = 1;
      
      private static const const_1091:uint = 2;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1091) : uint(const_671);
         var _loc6_:Boolean = this.var_192.width > 0 && this.var_192.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1025))
            {
               _loc5_ = const_1090;
            }
         }
         ...
         if(_loc5_ != const_671)
         {
            this.var_1556 = this.var_1025;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1090)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_670)
                  {
                     ...
                     _loc7_.draw(param1,this.var_128,this.var_128.rect,this.var_1025,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_34))
                  {
                     this.var_1100.tx = param2.x;
                     this.var_1100.ty = param2.y;
                     this.var_832.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_128,this.var_1100,this.var_832,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc2_ = this._skinContainer.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_174);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1556;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_792:
               this.var_1025 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1025 != this.var_1556)
               {
                  this.var_670 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1126:
               if(param1.testParamFlag(WindowParam.const_34))
               {
                  this.var_670 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1162:
               _loc4_ = true;
         }
         if(_loc4_)
         {
