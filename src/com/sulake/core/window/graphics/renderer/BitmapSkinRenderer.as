package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_895:Dictionary;
      
      protected var var_894:Dictionary;
      ...
      public function BitmapSkinRenderer(param1:String)
      {
         ...
         this.var_894 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc2_ = this.var_895[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_895[_loc1_];
            }
            this.var_895 = null;
            for(_loc1_ in this.var_894)
            {
               _loc2_ = this.var_894[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_894[_loc1_];
            }
            this.var_894 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_488[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_832.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_832.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_832.blueMultiplier = (param1.color & 255) / 255;
               this.var_832.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_832);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_335 == SkinLayoutEntity.const_316)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_335 == SkinLayoutEntity.const_540)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_335 == SkinLayoutEntity.const_348)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_335 == SkinLayoutEntity.const_585)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_333 == SkinLayoutEntity.const_316)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_540)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_585)
                  {
                  ...
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_348 || _loc10_.var_335 == SkinLayoutEntity.const_348)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_335 == SkinLayoutEntity.const_316)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_333 == SkinLayoutEntity.const_316)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_895[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_894[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
