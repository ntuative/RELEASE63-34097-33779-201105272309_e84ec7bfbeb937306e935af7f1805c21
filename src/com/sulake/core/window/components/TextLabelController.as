package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_348:Object = null;
      ...
      {
         return this.var_348 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_469);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_348 != null)
            {
               _loc1_.textColor = uint(this.var_348);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_469 != param1.name)
         {
            this.var_469 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2352 = _loc2_.textWidth;
         this.var_2351 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_348 != _loc2_.color : this.var_348 != null && this.var_348 != PropertyDefaults.const_712) ? new PropertyStruct(PropertyDefaults.const_375,this.var_348,PropertyStruct.const_160,true) : PropertyDefaults.const_1336);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_985)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_292,this.var_40.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_716);
            }
            if(this.var_40.top != PropertyDefaults.const_724)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,this.var_40.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_743);
            }
            if(this.var_40.right != PropertyDefaults.const_687)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,this.var_40.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_877);
            }
            if(this.var_40.bottom != PropertyDefaults.const_836)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,this.var_40.bottom,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_965);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_375:
                  this.var_348 = _loc2_.value as uint;
                  break;
               case PropertyDefaults.const_292:
                  if(this.var_40 || _loc2_.method_4)
                  {
