package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1568:String = "_SELECTOR";
      
      private static const const_1569:String = "_CONTENT";
       
      
      protected var var_1106:ITabSelectorWindow;
      
      protected var var_2182:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1106 = findChildByTag(const_1568) as ITabSelectorWindow;
            if(this.var_1106 != null)
            {
               this.var_1106.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2182 = findChildByTag(const_1569) as IWindowContainer;
         }
      ...
      {
         return !!this.var_854 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1106.numSelectables;
      }
