package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1318:IItemListWindow;
      
      private var var_467:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_467)
         {
            this.var_467.removeEventListener(WindowEvent.const_266,this.scrollBarEventProc);
            this.var_467.removeEventListener(WindowEvent.const_253,this.scrollBarEventProc);
            this.var_467 = null;
         }
         if(this.var_1318)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1318)
         {
            this.var_1318 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_467)
         {
            this.var_467 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_467)
            {
               this.var_467.addEventListener(WindowEvent.const_266,this.scrollBarEventProc);
               this.var_467.addEventListener(WindowEvent.const_253,this.scrollBarEventProc);
            }
         }
         return this.var_467;
      }
      ...
      {
         if(param1.type == WindowEvent.const_266)
         {
            this.showScrollBar();
         }
