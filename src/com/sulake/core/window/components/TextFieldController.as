package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1647:uint = 500;
      ...
      {
         this.var_1380 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_854 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_317,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_688,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1681);
         _loc1_.push(this.var_1377 != PropertyDefaults.const_1124 ? new PropertyStruct(PropertyDefaults.const_920,this.var_1377,PropertyStruct.const_38,true) : PropertyDefaults.const_1918);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1215 ? new PropertyStruct(PropertyDefaults.const_979,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1768);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1298 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1680);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_979:
                  ...
                  break;
               case PropertyDefaults.const_688:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1191:
