package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1360:Dictionary = createPropertySetterTable();
      ...
      private var var_469:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_469,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_469 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_469,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_844 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_469);
      }
      ...
      {
         this.var_896 = param1;
         this._field.scrollH = this.var_896 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_896 * this.maxScrollH,this.var_582 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_469);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_992,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1117));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1242 ? new PropertyStruct(PropertyDefaults.const_834,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1290) : PropertyDefaults.const_1741);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1186 ? new PropertyStruct(PropertyDefaults.const_1307,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1155) : PropertyDefaults.const_1915);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_712) ? new PropertyStruct(PropertyDefaults.const_375,this._field.textColor,PropertyStruct.const_160,true) : PropertyDefaults.const_1336);
         _loc1_.push(this.var_469 != TextStyleManager.const_209 ? new PropertyStruct(PropertyDefaults.const_373,this.var_469,PropertyStruct.const_52,true,PropertyDefaults.const_907) : PropertyDefaults.const_1146);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_985 ? new PropertyStruct(PropertyDefaults.const_292,this.var_40.left,PropertyStruct.const_42,true) : PropertyDefaults.const_716);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_724 ? new PropertyStruct(PropertyDefaults.const_246,this.var_40.top,PropertyStruct.const_42,true) : PropertyDefaults.const_743);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_687 ? new PropertyStruct(PropertyDefaults.const_294,this.var_40.right,PropertyStruct.const_42,true) : PropertyDefaults.const_877);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_836 ? new PropertyStruct(PropertyDefaults.const_251,this.var_40.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_965);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1183 ? new PropertyStruct(PropertyDefaults.const_925,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1942);
