package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1562:String = "_TITLE";
      
      private static const const_1565:String = "_HEADER";
      
      private static const const_1564:String = "_CONTENT";
      
      private static const const_1563:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1541:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1562) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1541 = findChildByTag(const_1565) as IHeaderWindow;
            if(!this.var_1541)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_196 = findChildByTag(const_1564) as IWindowContainer;
            if(!this.var_196)
            {
      ...
      {
         return findChildByTag(const_1563) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1359,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1099 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_342);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_341,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_292,_loc3_.left,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,_loc3_.top,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         return _loc1_;
      }
