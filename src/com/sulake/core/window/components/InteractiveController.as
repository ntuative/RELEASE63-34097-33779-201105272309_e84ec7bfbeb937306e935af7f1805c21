package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_483)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_483)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_788,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1920);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1211)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_968,param1.toolTipDelay,PropertyStruct.const_247,true));
         }
         else
         {
      ...
      {
         this.var_1380 = param1 == null ? "null" : param1;
      }
