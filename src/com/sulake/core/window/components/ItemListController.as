package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2191:Boolean = false;
      
      protected var var_580:Boolean = false;
      ...
      protected var var_711:Number = -1.0;
      
      protected var var_1107:Boolean = true;
      
      protected var var_489:Boolean = false;
      
      protected var var_1375:Boolean = false;
      
      protected var var_2192:int = 0;
      
      protected var var_2190:int = 0;
      
      protected var var_1373:Number;
      
      protected var var_1376:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_113 = 0;
         this.var_102 = 0;
         this._horizontal = param2 == WindowType.const_371;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_177 = var_481 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_439,WindowStyle.const_174,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_129,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_216,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1375;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_713)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_521,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_518,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_591,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_129,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_44:
               this.var_2192 = _loc3_;
               this.var_2190 = _loc4_;
               this.var_1373 = 0;
               this.var_1376 = 0;
               this.var_1374 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_211:
               if(this.var_1374)
               {
                  this.var_1373 = this.var_2192 - _loc3_;
                  this.var_1376 = this.var_2190 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1373 != 0 && this.var_113 != 0)
                     {
                        this.scrollH += this.var_1373 / this.var_113;
                     }
                  }
                  else if(this.var_1376 != 0 && this.var_102 != 0)
                  {
                     this.scrollV += this.var_1376 / this.var_102;
                  }
                  this.var_2192 = _loc3_;
                  this.var_2190 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_199:
               if(this.var_1374)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1373,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1376);
                  }
                  this.var_1374 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1107 && !this.var_580 && this._container)
         {
            this.var_580 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_854)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_421,this._spacing,PropertyStruct.const_42,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1350);
         }
         if(this.var_1107 != PropertyDefaults.const_1297)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_952,this.var_1107,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1805);
         }
         if(this.var_489 != PropertyDefaults.const_1150)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_765,this.var_489,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1906);
         }
         if(this.var_1375 != PropertyDefaults.const_1323)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_719,this.var_1375,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1730);
         }
         if(this.var_714 != PropertyDefaults.const_1138)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_843,this.var_714,PropertyStruct.const_132,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1855);
         }
         if(this.var_711 != PropertyDefaults.const_1301)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_762,this.var_711,PropertyStruct.const_132,true));
         }
         else
         {
