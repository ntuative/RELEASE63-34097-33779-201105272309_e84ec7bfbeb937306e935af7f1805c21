package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_265.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_308,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_185 == null || this.var_185.disposed)
         {
            this.var_185 = context.create(name + "::submenu","",WindowType.const_634,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_265.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_990 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_990)
         {
            if(this.open())
            {
               if(this.var_265.length)
               {
                  this.populateMenuItemContainer(this.var_265,this.getSubMenu(),this.subMenuEventProc);
                  this.var_990 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_990 = false;
            this.getTitleLabel().text = this.var_651 < this.var_265.length && this.var_651 > -1 ? this.var_265[this.var_651] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_629,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_439,var_84,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_651 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_651).setStateFlag(WindowState.const_57,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_816)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1268:
            case WindowMouseEvent.const_54:
               ...
               break;
            case WindowTouchEvent.const_705:
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_265[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_265.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_725,this.var_265,PropertyStruct.const_148,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_725)
            {
