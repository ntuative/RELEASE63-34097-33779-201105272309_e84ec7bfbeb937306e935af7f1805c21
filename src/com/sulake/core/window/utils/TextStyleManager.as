package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_542:Array;
      ...
      private static const const_1566:String = "/*";
      
      private static const const_1567:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_91[const_209],var_91[ITALIC],var_91[BOLD]];
            var_91.reset();
            var_91[const_209] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_542.indexOf(_loc4_.name) == -1)
            {
               var_542.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1566) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1567) + 2,_loc5_.length);
            }
