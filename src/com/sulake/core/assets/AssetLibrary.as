package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1340:String = "AssetLibraryReady";
      
      public static const const_879:String = "AssetLibraryLoaded";
      
      public static const const_1807:String = "AssetLibraryUnloaded";
      
      public static const const_1904:String = "AssetLibraryLoadError";
      
      private static const const_456:String = "name";
      
      private static const const_1068:String = "asset";
      ...
      private static var var_1905:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_533:uint = 0;
      
      private static var var_993:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_532 = new Dictionary(false);
         this.var_995 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1067);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1068);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_456);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_993.splice(var_993.indexOf(this),1);
            --var_533;
            this.var_532 = null;
            this.var_995 = null;
            this.var_165 = null;
      ...
      {
         if(this.var_654 == param1.url && this.var_992)
         {
            if(!this.var_994 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_653);
            }
            this.var_994 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1340));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_992 = false;
         this.var_654 = null;
         dispatchEvent(new Event(AssetLibrary.const_1807));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_995[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_532[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1262,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1120,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1199,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1264,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_532[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_532[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_532[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_165[param1] != null || (this.var_653 != null ? this.var_653[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1905.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_992 = true;
         dispatchEvent(new Event(AssetLibrary.const_879));
         dispatchEvent(new Event(AssetLibrary.const_1340));
         if(this.var_994)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1904));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1067);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1068);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_456).toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_653[param1]);
