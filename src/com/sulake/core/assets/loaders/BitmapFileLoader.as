package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1105 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1108 = new LoaderContext();
         this.var_1108.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1108);
         }
      }
      ...
      {
         this.var_1105 = param1.url;
         var_338 = 0;
         this.var_43.load(param1,this.var_1108);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_338 < var_2960)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1105 + (this.var_1105.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_338),this.var_1108);
               return true;
            }
         }
         return false;
