package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1451:String = "service-libraries";
      
      private static const const_1449:String = "library";
      
      private static const const_1445:String = "component-libraries";
      
      private static const const_1447:String = "library";
      
      private static const const_1453:String = "error_data";
      
      private static const const_1446:String = "error_cat";
      
      private static const const_1452:String = "error_desc";
       
      
      private var var_353:LibraryLoaderQueue;
      
      private var var_749:IEventDispatcher;
      
      private var var_507:uint;
      
      private var var_354:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1208:
               ...
               this.var_354 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_857:
               debug("Core; using complex frame update handler");
               this.var_354 = this.complexFrameUpdateHandler;
               break;
            case Core.const_686:
               debug("Core; using profiler frame update handler");
               this.var_354 = this.profilerFrameUpdateHandler;
               this.var_205 = new Profiler(this);
               attachComponent(this.var_205,[new IIDProfiler()]);
               var_409.addChild(new ProfilerViewer(this.var_205));
               break;
            case Core.const_631:
               debug("Core; using experimental frame update handler");
               this.var_354 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_354 = this.debugFrameUpdateHandler;
         }
      }
      
      public function getNumberOfFilesPending() : uint
      {
         return this.var_353.length;
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return this.var_507 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_252[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1453,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1446,String(param3));
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_749 = loadingEventDelegate;
         if(this.var_353 == null)
         {
            this.var_353 = new LibraryLoaderQueue(_debug);
         }
         try
         {
         ...
         try
         {
            node = config.child(const_1451)[0];
            if(node != null)
            {
               list = node.child(const_1449);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1214);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_749)
         {
            this.var_749.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_749)
         {
            ...
            this.var_749.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_749)
                  {
                     this.var_749.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_507 - this.var_353.length,this.var_507,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_205 ? 0 : this.var_1444 & 0;
         if(_loc3_ == Core.const_631)
         {
            this.var_252[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_252[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_205 ? 0 : this.var_1444 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_104)
         {
            _loc3_ = this.var_252[_loc5_] as Array;
            if(_loc4_ == Core.const_631)
            {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_354(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_605[priority] = 0;
            receivers = this.var_252[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_104)
         {
            ...
            {
               if(this.var_605[priority] < priority)
               {
                  ++this.var_605[priority];
                  skip = true;
               }
            }
            if(!skip)
