package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      private var var_491:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_491 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_491.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_491.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1444 & const_1171)
         {
            if(_loc3_ == 0)
            {
               if(this.var_491.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_491.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_491.getStructByIndex(_loc8_);
