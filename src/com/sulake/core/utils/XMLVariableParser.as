package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1935:String = "float";
      ...
      private static const const_676:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_675:String = "value";
      
      private static const const_662:String = "true";
      
      private static const const_1999:String = "HeightMapMessageEvent";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_676));
         }
         else
         {
            _loc4_ = param1.child(const_676)[0];
         }
         ...
         _loc7_ = param1.attribute(const_675);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_675));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_675)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_279 || _loc5_ == const_148)
            {
