package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1948:uint = 1;
      
      protected static const const_1947:uint = 2;
      
      protected static const const_1946:uint = 4;
      
      protected static const const_1949:uint = 3;
      ...
      public static const const_1261:Boolean = false;
      
      public static const const_1775:int = 2;
      
      private static var var_908:Array = new Array();
      ...
      protected var var_2947:String = "";
      
      protected var var_2168:int;
      
      protected var var_1362:int;
      
      protected var var_1361:int;
      
      protected var var_3027:uint = 0;
      
      protected var var_2948:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_43.load(param1.var_245,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1261)
         {
            ...
            while(var_720.length < const_1775 && false)
            {
               _loc1_ = var_908.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_720.push(_loc1_);
                  _loc1_.var_43.load(_loc1_.var_245,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1099 ? uint(this.var_1362 - this.var_2168) : uint(getTimer() - this.var_2168);
      }
      ...
      {
         if(this.var_1098 && !_disposed)
         {
            this.var_1098 = false;
            if(!this.var_1099 && this.var_245)
            {
               this.var_1362 = -1;
      ...
      {
         if(!this.var_1099 && !_disposed && this.var_1361 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_245,const_1898 - this.var_1361);
            if(this.var_2948)
            {
            ...
            --this.var_1361;
            this.var_479 = 0;
            this.var_43.load(this.var_245,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_479 == LibraryLoader.const_1949)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_653 = this.getDefinition(this._name) as Class;
         if(this.var_653 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_245.url + "!");
            }
            return false;
         }
         ...
         try
         {
            xmlClass = this.var_653.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
